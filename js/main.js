$(function() {
    ...
    const content = {
        fa: {
            ...
            çalışmaalanlarımız: "فعالیت ها",
            ekibimiz: " تیم ما   ",
            blog: " وبلاگ",
            iletişim: " ارتباط با ما",
            hızlıveetkilihukukidanışmanlıkhizmeti: "خدمات مشاوره حقوقی سریع و موثر",
            hero_ucretsiz_danismanlik: "مشاوره اولیه رایگان",
            hero_subtitle: "دفتر حقوقی متخصص مستقر در آنکارا با خدمات به زبان ترکی و فارسی",
            hero_whatsapp: "پیام در واتساپ",
            yıl_deneyim: "سال تجربه",
            uzman_avukat: "وکیل متخصص",
            hukuk_dalı: "شاخه حقوقی",
            dil_desteği: "پشتیبانی زبان",
            hakkımızda_paragraf_1:"ما به عنوان موسسه حقوقی پهلوان گوون متشکل از وکلای مجرب ترکیه و ایران با بیش از 10 سال سابقه فعالیتهای حقوقی و با تسلط لازم بر قوانین جاری هر دو کشور، آمادگی قبول مشاوره حقوقی، تنظیم قرارداد و قبول وکالت در محاکم هر دو کشور ایران و ترکیه را داریم. ",
        ...
        "<p>با اصلاحیه ای که در تاریخ 15 اکتبر 2024 در روزنامه رسمی منتشر شد، اصلاحیه بند ششم ماده 53 آیین نامه با عنوان سایر موارد در خصوص معافیت مجوز کار، مستثنی شدن کسانی که اقامت بشردوستانه و همچنین پناهندگان موقت در مادهای 49، 50 و ماده 51 همین آیین نامه در مورد معافیت های جواز کار آنها تصمیم گیری شده است.</p>"
            ...
            Denklik_ve_Diploma_İptallerinde_Kazanılmış_Hak_ve_İdarenin_İşlemi_Geri_Alma_Yetkisi:"در ابطال معادل سازی مدرک و مدارک تحصیلی، اختیار اداره در باز پس گیری تصمیمات اداری",
            Denklik_ve_Diploma_İptallerinde_Kazanılmış_Hak_ve_İdarenin_İşlemi_Geri_Alma_Yetkisi_kısa:"در دوره اخیر، اقدامات «ابطال معادل سازی» که توسط شورای آموزش عالی ترکیه (YÖK) اتخاذ شده است، به سطحی رسیده که به‌طور مستقیم بسیاری از حقوق اساسی مندرج در قانون اساسی، از جمله حق مالکیت و آزادی اشتغال، را تحت تأثیر قرار می‌دهد.",
            Denklik_ve_Diploma_İptallerinde_Kazanılmış_Hak_ve_İdarenin_İşlemi_Geri_Alma_Yetkisi_uzun:
                [
                    "در دوره اخیر، اقدامات «ابطال معادل سازی» که توسط شورای آموزش عالی ترکیه (YÖK) اتخاذ شده است، به سطحی رسیده که به‌طور مستقیم بسیاری از حقوق اساسی مندرج در قانون اساسی، از جمله حق مالکیت و آزادی اشتغال، را تحت تأثیر قرار می‌دهد. به‌ویژه تغییرات ایجادشده در فرآیندهای شناسایی و معادل سازی مدارک فارغ‌التحصیلان دانشگاه پیام نور (PNU)، در چارچوب اصول بنیادین حقوق اداری همچون «امنیت حقوقی»، «ثبات اداری» و «حق مکتسبه»، مشمول نظارت جدی قضایی می‌باشد.",
                    "<p></p>",
                    "در این مقاله، حدود اختیار اداره در استرداد تصمیمات صادره از سوی خود و همچنین مغایرت‌های حقوقی ابطال معادل سازی‌هایی که پس از سالیان طولانی انجام می‌گیرد، مورد بررسی قرار می‌گیرد.",
                    "<p></p>",
                    "<h6>1. اختیار اداره در استرداد تصمیم اداری و محدودیت «مدت معقول» زمانی</h6>",
                    "Yerleşik Danıştay içtihatları, idarenin kendi hatasından kaynaklanan işlemlerini ancak dava açma süresi olan 60 gün içerisinde geri alabileceğini kabul eder. " +
                    "<p></p>",
                    "اداره اصولاً اختیار نامحدود برای استرداد تصمیمات مغایر با قانون خود ندارد. رویه تثبیت‌ شده دیوان عالی اداری (دانیشتای) و دکترین حقوقی بر این امر تأکید دارند که اداره تنها می‌تواند تصمیماتی را که ناشی از اشتباه خود بوده‌اند، در مهلت طرح دعوا (۶۰ روز) مسترد نماید.",
                    "<p></p>",
                    "بر اساس رأی هیئت وحدت رویه دیوان عالی اداری به تاریخ 22.12.1973 به شماره E:1968/8، K:1973/14 : اداره به جز در موارد  مثل «عدم وجود مدرک یعنی بطلان»، «تقلب در مدارک» یا «اشتباه واضح »، تنها در مهلت طرح دعوا مجاز به استرداد تصمیمات اداریِ خود برای اشخاص می‌باشد. پس از انقضای این مدت، استرداد تصمیم اداره، اصل «ثبات اداری» را مخدوش می‌سازد.",
                    "<h6>2 .حق مکتسبه و اصل امنیت حقوقی</h6>",
                    "گواهی معادل سازی، برای شخص ذی ‌نفع، وضعیت علمی و حرفه‌ای  برای استفاده از این حق ایجاد می‌کند. این گواهی که پس از بررسی‌های انجام‌شده توسط YÖK و بدون هرگونه تقلب یا اظهار خلاف واقع از سوی شخص صادر شده  با گذشت مدت معقول، منجر به ایجاد حق مکتسبه برای شخص می شود.",
                    "<p></p>",
                    "اصل امنیت حقوقی اقتضا دارد که اعتماد افراد به نظام حقوقی حفظ شود. فردی که سال‌ها پیش بر اساس یک معادل سازی معتبر، تحصیلات تکمیلی انجام داده، در بخش دولتی مشغول به کار شده یا حرفه آزاد خود را آغاز کرده است، نمی‌تواند با تغییر نظر بعدی اداره، ناگهان با نابودی کامل مسیر شغلی و حرفه‌ای خود مواجه شود؛ چنین وضعیتی با اصل حاکمیت قانون سازگار نیست.",
                    "<p></p>",
                    "<h6> 3  . استثنائات اختیار استرداد: تقلب و اشتباه واضح</h6>",
                    "اداره تنها در دو حالت می‌تواند بدون محدودیت زمانی  تصمیم خود را مسترد نماید:",
                    "<strong>1. تقلب:</strong> در صورتی که شخص با ارائه اسناد جعلی یا فریب اداره موجب صدور تصمیم شده باشد، شرط زمان اعمال نمی‌شود.",
                    "<strong>2. اشتباه واضح:</strong> اشتباهی که به ‌قدری واضح باشد که همگان بتوانند آن را تشخیص دهند. با این حال، اختلاف در تفسیر مقررات یا ارزیابی‌های ذهنی مانند «مناسب بودن مدل آموزشی» در زمره اشتباه آشکار محسوب نمی‌شود.",
                    "<p></p>",
                    "<h6>4 . تصمیمات مربوط به دانشگاه پیام نور و تحلیل حقوقی</h6>",
                    "در تصمیمات ابطال صادره از سوی YÖK درباره فارغ‌التحصیلان دانشگاه پیام نور، معمولاً این استدلال مطرح می‌شود که «تحصیل به‌صورت آموزش از راه دور انجام شده و این امر بعداً مشخص شده است». اما در صورتی که:",
                    "<strong>1.</strong> مدل آموزشی دانشگاه در زمان صدور معادلسازی مورد بررسی اداره قرار گرفته باشد؛",
                    "<strong>2.</strong> نوع آموزش در ضمائم مدرک به‌طور صریح ذکر شده باشد؛",
                    "<strong>3.</strong> شخص کلیه اسناد خود را به‌صورت کامل ارائه کرده باشد؛,",
                    "دیگر نمی‌توان از «تقلب» یا «اشتباه واضح» سخن گفت. آنچه در اینجا رخ داده، صرفاً تمایل اداره به استفاده متفاوت از اختیار تشخیصی خود در مقطع کنونی است که این امر با اصل منع عطف به ماسبق شدن تصمیمات اداری مغایرت دارد.",
                    "<p></p>",
                    "<h6>5 . ارزیابی در پرتو آرای قضایی</h6>",
                    "دیوان عالی اداری و دادگاه قانون اساسی ترکیه در مواردی که شخص کلیه تکالیف قانونی خود را انجام داده و پس از عبور از فیلترهای نظارتی اداره، صاحب حق شده است، تحمیل اشتباه اداره به فرد را مغایر با قانون دانسته‌اند.",
                    "<strong>✦ مرور زمان:</strong> ابطال معادل سازی پس از گذشت ۱۰، ۲۰ یا حتی ۳۰ سال، در چارچوب کنوانسیون اروپایی حقوق بشر، می‌تواند نقض «حق احترام به زندگی خصوصی» و «حق مالکیت» تلقی شود.",
                    "<strong>✦ صداقت اداری: </strong> اداره مکلف است با شهروندان خود صادقانه رفتار کند و به نتایج حقوقی‌ای که خود ایجاد کرده است، وفادار بماند.",
                    "<p></p>",
                    "<h6>نتیجه‌گیری</h6>",
                    "ابطال معادل سازی صرفاً به معنای پس گرفتن یک سند نیست؛ بلکه به معنای ابطال گذشته، تلاش‌ها و آینده یک انسان است. افرادی که از دانشگاه پیام نور یا مؤسسات مشابه خارجی فارغ‌التحصیل شده و با ابطال معادلسازی مواجه شده‌اند، باید ظرف مهلت قانونی از تاریخ ابلاغ، با درخواست صدور دستور موقت، دعوای ابطال تصمیم اداری را در دادگاه اداری آنکارا  مطرح نمایند؛ چراکه این امر از اهمیت حیاتی برخوردار است.",
                    "<p></p>",
                    "نباید فراموش کرد که کلیه اعمال و تصمیمات اداری مشمول نظارت قضایی بوده و «حقوق مکتسبه» تحت حمایت قانون اساسی قرار گرفته است. ",

                ],

            Fazla_Mesai_ve_Fazla_Sürelerle_Çalışma_Ücretinin_Hesaplanması:"۱ .محاسبه اضافه‌کاری و دستمزد کار با ساعات مازاد",
            Fazla_Mesai_ve_Fazla_Sürelerle_Çalışma_Ücretinin_Hesaplanması_kısa:"محاسبه، پرداخت و اثبات اضافه‌کاری و کار با ساعات مازاد، در چارچوب قانون کار شماره ۴۸۵۷ و آیین‌نامه‌های مربوطه تنظیم شده است.",
            Fazla_Mesai_ve_Fazla_Sürelerle_Çalışma_Ücretinin_Hesaplanması_uzun:
                [
                    "محاسبه، پرداخت و اثبات اضافه‌کاری و کار با ساعات مازاد، در چارچوب قانون کار شماره ۴۸۵۷ و آیین‌نامه‌های مربوطه تنظیم شده است.",
                    "<p></p>",
                    "کار با ساعات مازاد به دو نوع «اضافه‌کاری» و «کار با ساعات مازاد کمتر از حد اضافه‌کاری» تقسیم می‌شود. در محاسبه، ابتدا نوع کار انجام‌شده و سپس درصد افزایش مربوط به آن تعیین می‌گردد.",
                    "<p></p>",

                    "<h6>الف) نرخ‌ها و مدت‌ها در محاسبه</h6>",

                    "<strong>۱.  دستمزد اضافه‌کاری:</strong>",
                    "<strong>✦ تعریف: :</strong> طبق شرایط مقرر در قانون، کارهایی که بیش از ۴۵ ساعت در هفته انجام شود، اضافه‌کاری محسوب می‌گردد.",
                    "<strong>✦ دستمزد :</strong> برای هر ساعت اضافه‌کاری، دستمزدی معادل ۵۰٪ بیشتر از دستمزد عادی ساعتی پرداخت می‌شود.",
                    "<p></p>",

                    "<strong>۲.  دستمزد کار با ساعات مازاد:</strong>",
                    "<strong>✦ تعریف:</strong> در مواردی که مدت کار هفتگی طبق قرارداد کمتر از ۴۵ ساعت تعیین شده باشد، کارهایی که از متوسط مدت کار هفتگی فراتر رود ولی از ۴۵ ساعت تجاوز نکند، کار با ساعات مازاد محسوب می‌شود.",
                    "<strong>✦ دستمزد:</strong> رای هر ساعت کار با ساعات مازاد، دستمزدی معادل ۲۵٪ بیشتر از دستمزد عادی ساعتی پرداخت می‌شود.",
                    "<strong>✦ </strong> با توافق طرفین، امکان پرداخت این کار با نرخ اضافه‌کاری (۵۰٪ افزایش) نیز وجود دارد.",
                    "<p></p>",

                    "<strong>۳.  اضافه‌کاری در معادن زیرزمینی:</strong>",
                    "<strong>✦</strong> حداکثر مدت کار هفتگی در معادن زیرزمینی ۳۷٫۵ ساعت است.",
                    "<strong>✦</strong> برای هر ساعت کاری که از این مدت تجاوز کند، دستمزدی با افزایشی حداقل ۱۰۰٪ نسبت به دستمزد عادی ساعتی پرداخت می‌شود.",
                    "<p></p>",

                    "<h6>ب) دستمزد و مدت‌های مبنای محاسبه</h6>",
                    "<strong>✦ نوع دستمزد: </strong> در محاسبه اضافه‌کاری، دستمزد ناخالص پایه ساعتی کارگر ملاک است. محاسبه بر اساس دستمزد ناخالص مزایادار یا دستمزد خالص، طبق رویه دیوان عالی کشور، موجب نقض رأی می‌شود.",
                    "<strong>✦ دستمزد دوره‌ای:</strong> دستمزد مورد محاسبه، دستمزد مربوط به همان دوره است، نه آخرین دستمزد دریافتی. در صورت عدم امکان تعیین دستمزد دوره‌های گذشته، می‌توان با نسبت‌گیری آخرین دستمزد شناخته‌شده به حداقل دستمزد، دستمزد دوره‌های قبل را محاسبه نمود.",
                    "<strong>✦ قاعده گرد کردن: </strong> در محاسبه اضافه‌کاری، مدت کمتر از نیم ساعت، نیم ساعت و مدت بیش از نیم ساعت، یک ساعت کامل محسوب می‌شود.",
                    "<strong>✦ حداکثر روزانه: </strong> مجموع ساعات کار روزانه، با احتساب اضافه‌کاری، نباید از ۱۱ ساعت تجاوز کند. حتی اگر مجموع هفتگی از ۴۵ ساعت تجاوز نکند، ساعات بیش از ۱۱ ساعت در روز اضافه‌کاری محسوب می‌شود.",
                    "<strong>✦ حداکثر سالانه</strong> مجموع اضافه‌کاری سالانه برای هر کارگر نباید از ۲۷۰ ساعت تجاوز کند. با این حال، حتی در صورت تجاوز از این حد، به‌منظور حمایت از کارگر، پرداخت دستمزد ساعات مازاد الزامی است.",
                    "<p></p>",

                    "<h6>ج) محاسبه در اشکال خاص کار</h6>",
                    "<strong>✦ کار در روز تعطیل هفتگی :</strong> در صورت اشتغال کارگر در روز تعطیل هفتگی، علاوه بر دستمزد یک روز استحقاقی، برای کار انجام‌شده دستمزد با ۵۰٪ افزایش (معادل ۱٫۵ روز) پرداخت می‌شود که در مجموع برابر با ۲٫۵ روز دستمزد است.",
                    "<strong>✦ کار در زمان استراحت: </strong> چنانچه کارگر بنا به دستور کارفرما در زمان استراحت مشغول کار باشد یا آماده به کار نگه داشته شود، این مدت جزء ساعات کار محسوب شده و در صورت تجاوز از ۴۵ ساعت هفتگی، مشمول اضافه‌کاری می‌گردد.",
                    "<strong>✦ دستمزد مبتنی بر پورسانت و درصد: </strong> در سیستم دستمزد درصدی، بخش بدون افزایش اضافه‌کاری از محل درصدها پرداخت می‌شود و فقط مابه‌التفاوت افزایشی (۲۵٪ یا ۵۰٪) بر عهده کارفرماست. در مورد دستمزد مبتنی بر پاداش (پرایم)، رویه دیوان عالی کشور بر این است که پاداش، معادل دستمزد عادی اضافه‌کاری تلقی شده و فقط ۵۰٪ افزایشی به‌عنوان اضافه‌کاری محاسبه شود.",
                    "<p></p>",

                    "<h6>۲.  پرداخت اضافه‌کاری و کار با ساعات مازاد و عوض آن</h6>",
                    "کارگر برای جبران اضافه‌کاری یا کار با ساعات مازاد، دو انتخاب دارد: دریافت دستمزد افزایشی یا استفاده از زمان آزاد.",
                    "<p></p>",

                    "<strong>الف) پرداخت و بهره</strong>",
                    "<strong>✦ نحوه پرداخت: </strong> دستمزد اضافه‌کاری باید همراه با دستمزد عادی و به‌صورت شفاف در فیش حقوقی و برگه محاسبه دستمزد درج و پرداخت شود.",
                    "<strong>✦ بهره:</strong> از آنجا که اضافه‌کاری از نوع مطالبات مزدی است، طبق ماده ۳۴ قانون کار، بالاترین نرخ بهره سپرده‌های بانکی اعمال می‌شود. در صورت عدم وقوع تأخیر قبلی، تاریخ شروع بهره اصولاً تاریخ طرح دعواست. با این حال، در موارد ارجاع اجباری به میانجی‌گری، تاریخ مراجعه به میانجی‌گر مبنای محاسبه بهره خواهد بود.",
                    "<p></p>",

                    "<strong>ب) استفاده از زمان آزاد</strong>",
                    "<strong>✦ معادل‌ها:</strong> ",
                    "<strong>o</strong> به‌ازای هر ساعت اضافه‌کاری: ۱٫۵ ساعت زمان آزاد",
                    "<strong>o</strong> به‌ازای هر ساعت کار با ساعات مازاد: ۱٫۲۵ ساعت زمان آزاد",
                    "<p></p>",
                    "<strong>✦ نحوه استفاده:</strong> کارگر می‌تواند این زمان را ظرف شش ماه، در ساعات کاری و بدون کسر دستمزد استفاده کند. درخواست باید قبلاً به‌صورت کتبی به کارفرما اعلام شود.",
                    "<strong>✦ محدودیت‌ها: </strong> در اضافه‌کاری‌های ناشی از علل اجباری یا فوق‌العاده، کارگر نمی‌تواند از حق دستمزد افزایشی صرف‌نظر کرده و تقاضای زمان آزاد نماید.",
                    "<strong>✦ عدم استفاده:</strong> در صورت عدم استفاده از زمان آزاد ظرف شش ماه یا خاتمه قرارداد، دستمزد اضافه‌کاری باید به کارگر پرداخت شود.",
                    "<p></p>",

                    "<h6>۳.  اثبات و مستندسازی اضافه‌کاری و کار با ساعات مازاد</h6>",
                    "<p></p>",
                    "<strong>الف) تکلیف مستندسازی</strong>",
                    "کارفرما مکلف است اسناد مربوط به ساعات اضافه‌کاری و کار با ساعات مازاد را تنظیم کرده، نسخه‌ای امضاشده را در پرونده پرسنلی کارگر نگهداری نماید. پرداخت‌ها نیز باید در فیش حقوقی به‌طور شفاف درج شود.",
                    "<p></p>",
                    "<strong>ب) بار اثبات</strong>",
                    "<strong>✦ کارگر: </strong> کارگری که مدعی انجام اضافه‌کاری است، باید ادعای خود را با شهادت شهود یا سایر ادله اثبات کند.",
                    "<strong>✦ کارفرما:</strong> اثبات پرداخت دستمزد اضافه‌کاری بر عهده کارفرماست و معمولاً از طریق فیش‌های حقوقی انجام می‌شود.",
                    "<strong>✦ نقش فیش حقوقی::</strong> ",
                    "<strong>o</strong> فیش امضاشده توسط کارگر، تا زمانی که جعلیت آن اثبات نشود، دلیل قطعی محسوب می‌شود.",
                    "<strong>o</strong> در فیش‌های بدون امضا یا فیش‌هایی که بخش اضافه‌کاری در آن خالی است، کارگر می‌تواند با هر دلیلی اضافه‌کاری را اثبات نماید.",
                    "<p></p>",
                    "<strong>ج) کسر عادلانه مبتنی بر قرینه (کسر انصاف)</strong>",
                    "چنانچه اثبات اضافه‌کاری صرفاً بر شهادت شهود استوار باشد، باید از مبلغ محاسبه‌شده کسر معقولی اعمال شود. این کسر مبتنی بر این قرینه است که کارگر در تمام ایام سال به‌طور مستمر کار نکرده است. میزان کسر باید متناسب با محتویات پرونده بوده و در عمل کمتر از ۳۰٪ اعمال نمی‌شود. در صورت اثبات اضافه‌کاری با اسناد کتبی یا سوابق کارفرما، این کسر اعمال نخواهد شد.",
                    "<p></p>",
                    "<strong>د) مرور زمان</strong>",
                    "مطالبات اضافه‌کاری مشمول مرور زمان پنج‌ساله است. این مدت از تاریخ قابل مطالبه شدن دین آغاز می‌شود. همچنین مدت زمان بین شروع فرآیند میانجی‌گری تا تنظیم صورت‌جلسه نهایی، در محاسبه مرور زمان لحاظ نمی‌شود (مرور زمان متوقف می‌گردد).",
                ],

            Gece_Çalışmasında_Fazla_Mesai:"اضافه‌کاری در کار شبانه (کار با ساعات اضافی)",
            Gece_Çalışmasında_Fazla_Mesai_kısa:"بدون تردید، موضوع اضافه‌کاری در کار شبانه، در راستای اصل حمایت از سلامت کارگر، شامل مقررات ویژه‌ای است و این مقررات از احکام عمومی مربوط به اضافه‌کاری متفاوت می‌باشند.",
            Gece_Çalışmasında_Fazla_Mesai_uzun:
                [
                    "بدون تردید، موضوع اضافه‌کاری در کار شبانه، در راستای اصل حمایت از سلامت کارگر، شامل مقررات ویژه‌ای است و این مقررات از احکام عمومی مربوط به اضافه‌کاری متفاوت می‌باشند.",
                    "<p></p>",
                    "در ادامه، بر اساس اطلاعات مندرج در منابع شما، نحوه محاسبه و حدود اضافه‌کاری (کار با ساعات اضافی) در کار شبانه به‌تفصیل بیان شده است:",
                    "<p></p>",
                    "<h6>1. تعریف کار شب و مدت زمان کار</h6>",
                    "مطابق قانون کار شماره ۴۸۵۷، «شب» در زندگی کاری به دوره‌ای اطلاق می‌شود که حداکثر از ساعت ۲۰:۰۰ آغاز و حداقل تا ساعت ۰۶:۰۰ ادامه دارد و در هر حال بیش از یازده ساعت نخواهد بود.",
                    "<p></p>",
                    "قاعده اساسی مربوط به دوره شب، طبق ماده ۶۹ بند ۳ قانون کار، این است که کار شبانه کارگران نمی‌تواند بیش از هفت ساعت و نیم (۷٫۵ ساعت) باشد.",
                    "<p></p>",
                    "در کارهایی که به‌صورت نوبتی (شیفتی) انجام می‌شود، چنانچه بیش از نیمی از کار یک نوبت در دوره شب واقع شود، آن نوبت به‌عنوان کار شبانه محسوب می‌گردد.",
                    "<p></p>",
                    "<h6>2.  حدود اضافه‌کاری و استثنائات آن</h6>",
                    "در کار شبانه، مدت ۷٫۵ ساعت، حد نهایی کار روزانه و به تبع آن، حد اضافه‌کاری را تعیین می‌کند. این حد حتی در صورتی که سقف قانونی ۴۵ ساعت کار هفتگی تجاوز نشده باشد نیز اعمال می‌شود؛ یعنی به محض آنکه کار شبانه از ۷٫۵ ساعت تجاوز کند، برای بخش مازاد، پرداخت اضافه‌کاری الزامی است.",
                    "<p></p>",
                    "این قاعده دارای دو استثنای اصلی می‌باشد:",
                    "<strong>1. کار به دلیل ضرورت‌ها و شرایط فوق‌العاده </strong> محدودیت ۷٫۵ ساعت در کار شبانه، مربوط به اضافه‌کاری ناشی از علل عادی است. در موارد اضافه‌کاری ناشی از دلایل اجباری موضوع ماده ۴۲ قانون کار یا دلایل فوق‌العاده موضوع ماده ۴۳ قانون کار، انجام کار بیش از ۷٫۵ ساعت در دوره شب نیز امکان‌پذیر است.",
                    "<strong>2. حوزه‌های خدماتی خاص (با رضایت کتبی): </strong> در بخش‌های گردشگری، امنیت خصوصی و خدمات درمانی، مشروط بر اخذ رضایت کتبی کارگر، می‌توان بیش از ۷٫۵ ساعت کار شبانه انجام داد.",
                    "<strong>o </strong> در این حوزه‌ها، چنانچه کارگر رضایت کتبی داده باشد، تا میزان مدت مورد رضایت، کار بیش از ۷٫۵ ساعت مستحق دستمزد اضافه‌کاری نخواهد بود.",
                    "<strong>o </strong> اما در صورت عدم رضایت کتبی کارگر، وی می‌تواند برای ساعات مازاد بر ۷٫۵ ساعت، مطالبه دستمزد اضافه‌کاری نماید.",
                    "<p></p>",
                    "<h6>3.  محاسبه دستمزد اضافه‌کاری در کار شبانه</h6>",
                    "در محاسبه دستمزد اضافه‌کاری برای ساعات مازاد بر ۷٫۵ ساعت کار شبانه، نکات زیر باید مدنظر قرار گیرد:",
                    "<strong>✦ نرخ افزایش: </strong> بخش مازاد بر ۷٫۵ ساعت کار شبانه، ماهیت اضافه‌کاری دارد. چنانچه سقف ۴۵ ساعت کار هفتگی تجاوز نشده باشد، از آنجا که بخش عادی (بدون افزایش) اضافه‌کاری در حقوق ماهانه پرداخت‌شده فرض می‌شود، تنها مبلغ افزایش‌یافته به میزان پنجاه درصد (٪۵۰) باید به کارگر پرداخت گردد.",
                    "<strong>✦ محاسبه متفاوت در کار شیفتی (رویه دیوان عالی کشور – یارگیتای) </strong> در نظام‌های خاص کاری مانند ۲۴ ساعت کار و ۲۴ یا ۴۸ ساعت استراحت (برای مثال آتش‌نشانان)، مطابق رویه ثابت دیوان عالی کشور، به‌جای حد ۷٫۵ ساعت کار شبانه، حداکثر ۱۱ ساعت کار روزانه مبنا قرار می‌گیرد.\n" +
                    "در این نظام‌ها، کار بیش از ۱۱ ساعت در روز اضافه‌کاری محسوب می‌شود و اضافه‌کاری شبانه تلقی نمی‌گردد. با این حال، برخی از صاحب‌نظران حقوقی بر این باورند که در صورتی که بخش عمده کار در شب انجام شود، اعمال حد ۷٫۵ ساعت منطقی‌تر است.\n",
                    "<p></p>",
                    "<h6>4. اشخاصی که انجام اضافه‌کاری برای آنان ممنوع است</h6>",
                    "در چارچوب کار شبانه، برای برخی گروه‌های کارگری محدودیت‌های سخت‌گیرانه‌تری وجود دارد:",
                    "<strong>✦ کودکان و کارگران نوجوان: </strong> کارگران زیر ۱۸ سال طبق قانون کار، از اشتغال در دوره شب (۲۰:۰۰ تا ۰۶:۰۰) منع شده‌اند و اصولاً انجام اضافه‌کاری برای آنان مجاز نیست.",
                    "<strong>✦ زنان باردار و شیرده: </strong> زنان باردار یا شیرده نمی‌توانند بیش از ۷٫۵ ساعت در روز کار کنند. همچنین این افراد تا مدت معینی پس از زایمان (معمولاً یک سال) از کار در شیفت‌های شبانه منع می‌باشند. اصولاً انجام اضافه‌کاری برای این گروه نیز مجاز نیست.",
            ...
            blog25_baslik: "راهنمای جبران خسارت مادی و معنوی پس از تصادف رانندگی",
            blog25_icerik: "<h3>راهنمای جبران خسارت مادی و معنوی پس از تصادف رانندگی: حقوق، محاسبات و روند قانونی</h3><p>تصادفات رانندگی، در نظام حقوقی ما در چارچوب «مسئولیت ناشی از فعل زیان‌بار» ارزیابی می‌شوند و رویدادهایی هستند که آثار اقتصادی و روانی سنگینی بر قربانیان می‌گذارند. برای اینکه پس از حادثه دچار تضییع حق نشوید، آگاهی از انواع خسارت و روش‌های محاسبه فنی آن‌ها اهمیت زیادی دارد.</p><h4>1. ماهیت حقوقی دعوای جبران خسارت ناشی از تصادف رانندگی</h4><p>دعوی جبران خسارت ناشی از تصادف رانندگی، در نتیجه وقوع تصادفی که حداقل یک وسیله نقلیه موتوری در آن دخیل است و منجر به خسارت بدنی (فوت، جراحت) یا خسارت مالی می‌شود، مطرح می‌گردد. این دعاوی بر اساس ماده 49 قانون تعهدات ترکیه و قانون راهنمایی و رانندگی شماره 2918 می‌باشد.</p><h5>دعوی علیه چه کسانی قابل طرح است؟</h5><ul><li><strong>راننده وسیله نقلیه:</strong> شخصی که در حادثه مقصر است.</li><li><strong>مالک و بهره‌بردار وسیله نقلیه:</strong> شخصی که در سند راهنمایی و رانندگی به عنوان مالک ثبت شده و به صورت تضامنی مسئول است.</li><li><strong>شرکت بیمه:</strong> مؤسسه‌ای که بیمه شخص ثالث یا بیمه بدنه وسیله نقلیه را انجام داده است.</li><li><strong>صندوق تضمین:</strong> در مواردی که وسیله نقلیه بیمه ندارد یا عامل حادثه مشخص نیست.</li></ul><h4>2. انواع خسارت و دامنه آن</h4><h5>A. خسارت از کارافتادگی موقت و دائم (ناتوانی)</h5><p>این خسارت، جبران کاهش توان کاری فرد در نتیجه آسیب جسمی است.</p><ul><li><strong>از کارافتادگی موقت:</strong> دوره درمان که فرد قادر به کار نیست و در این مدت ناتوانی %100 محسوب می‌شود.</li><li><strong>از کارافتادگی دائم:</strong> در صورت باقی ماندن آسیب دائمی، خسارت ناشی از کاهش درآمد در طول عمر فرد است.</li></ul><h5>B. خسارت محرومیت از نفقه (در تصادفات منجر به فوت)</h5><p>این خسارت برای جبران زیان افرادی است که متوفی در زمان حیات به طور واقعی و منظم از آن‌ها حمایت مالی می‌کرده است.</p><ul><li><strong>مفهوم حمایت:</strong> فقط به تعهد قانونی محدود نیست، بلکه بر رابطه واقعی نیز مبتنی است.</li><li><strong>نفقه فرضی:</strong> در صورت فوت کودک، فرض می‌شود در آینده از والدین حمایت می‌کرد.</li></ul><h5>C. خسارت کاهش ارزش خودرو</h5><p>حتی اگر خودرو تعمیر شود، تفاوت بین ارزش بازار قبل از حادثه و بعد از حادثه، خسارت کاهش ارزش است.</p><h5>D. خسارت معنوی</h5><p>برای جبران درد، اندوه و ناراحتی ناشی از حادثه درخواست می‌شود و دادگاه بر اساس انصاف تعیین می‌کند.</p><h4>3. نحوه محاسبه خسارت (جزئیات فنی)</h4><ul><li><strong>سن و مدت کار:</strong> 18 تا 65 سال دوره فعال، 65 تا 72 سال دوره غیرفعال محسوب می‌شود.</li><li><strong>درآمد:</strong> درآمد رسمی ملاک است؛ در صورت نبود، حداقل دستمزد.</li><li><strong>جداول عمر:</strong> با استفاده از جداول TRH-2010 یا PMF و نرخ تنزیل %1.65.</li><li><strong>تقصیر و کسر:</strong> به میزان تقصیر فرد از خسارت کسر می‌شود. همچنین پرداخت‌های تأمین اجتماعی نیز کسر می‌گردد.</li></ul><h4>4. وضعیت‌های خاص: اتباع خارجی</h4><p>اتباع خارجی که در ترکیه دچار تصادف می‌شوند نیز حق دریافت خسارت دارند. در این حالت، محاسبه بر اساس حداقل دستمزد ترکیه نیست، بلکه بر اساس درآمد و سطح زندگی کشور فرد انجام می‌شود.</p><h4>5. مهلت‌های قانونی و الزامات</h4><ul><li><strong>الزام مراجعه به بیمه:</strong> قبل از طرح دعوی باید به شرکت بیمه به صورت کتبی مراجعه شود.</li><li><strong>مرور زمان:</strong> 2 سال از تاریخ اطلاع از خسارت و عامل، و در هر حال 10 سال از تاریخ حادثه. اگر حادثه جرم باشد (جرح یا فوت)، مرور زمان کیفری طولانی‌تر (8 تا 15 سال) اعمال می‌شود.</li></ul><hr><h4>سوالات متداول درباره روند جبران خسارت تصادفات رانندگی</h4><p><strong>1. پس از تصادف رانندگی چقدر زمان برای طرح دعوای خسارت دارم؟</strong><br>در تصادفات رانندگی، مهلت مرور زمان از تاریخ اطلاع از خسارت و عامل حادثه 2 سال است و در هر حال از تاریخ وقوع حادثه 10 سال می‌باشد. اما اگر حادثه یک جرم محسوب شود، مرور زمان‌های طولانی‌تر کیفری (بین 8 تا 15 سال) اعمال می‌شود.</p><p><strong>2. نزدیکان فرد فوت‌شده در تصادف چه خسارت‌هایی می‌توانند مطالبه کنند؟</strong><br>در تصادفات منجر به فوت، نزدیکان می‌توانند هزینه‌های کفن و دفن، هزینه‌های درمانی و خسارت محرومیت از نفقه را مطالبه کنند. همچنین حق طرح دعوای خسارت معنوی را نیز دارند.</p><p><strong>3. آیا خسارت محرومیت از نفقه فقط به وراث قانونی پرداخت می‌شود؟</strong><br>خیر. هر شخصی که در زمان حیات متوفی به طور واقعی و منظم از او حمایت مالی دریافت کرده باشد می‌تواند این خسارت را مطالبه کند.</p><p><strong>4. اگر خودروی من تعمیر شده ولی ارزش بازار آن کاهش یافته است چه باید کرد؟</strong><br>در این حالت می‌توانید خسارت کاهش ارزش خودرو را مطالبه کنید. تفاوت بین ارزش بازار خودرو قبل از حادثه و ارزش آن پس از تعمیر، باید توسط شرکت بیمه جبران شود.</p><p><strong>5. اگر در تصادف خودم هم مقصر باشم، باز هم می‌توانم خسارت بگیرم؟</strong><br>بله، اما میزان خسارت به نسبت درصد تقصیر شما کاهش می‌یابد.</p><p><strong>6. آیا قبل از طرح دعوا، مراجعه به شرکت بیمه الزامی است؟</strong><br>بله. طبق قانون راهنمایی و رانندگی شماره 2918، قبل از طرح دعوا باید به صورت کتبی به شرکت بیمه مراجعه شود.</p><p><strong>7. آیا افراد خارجی که در ترکیه تصادف کرده‌اند می‌توانند خسارت بگیرند؟</strong><br>بله. اتباع خارجی نیز حق دریافت خسارت بدنی دارند. در این موارد، محاسبه خسارت بر اساس درآمد و سطح زندگی کشور فرد زیان‌دیده انجام می‌شود.</p><p><strong>8. شرکت بیمه چه مدت برای پرداخت خسارت زمان دارد؟</strong><br>پس از ارائه تمام مدارک لازم، شرکت بیمه موظف است ظرف 8 روز کاری خسارت را پرداخت کند.</p><p><strong>9. چرا سن فرد در محاسبه خسارت مهم است؟</strong><br>زیرا در محاسبات خسارت، مدت زمان باقی‌مانده برای کار کردن و کسب درآمد فرد مبنا قرار می‌گیرد.</p><hr><p><em><strong>توجه:</strong> محاسبه خسارت‌های تصادف رانندگی یک فرآیند تخصصی اکچوئری است. برای جلوگیری از تضییع حقوق، استفاده از وکیل متخصص توصیه می‌شود.</em></p>",
            blog25_kisa: "راهنمای حقوق جبران خسارت مادی و معنوی پس از تصادف رانندگی، روش‌های محاسبه و روند قانونی.",

            blog26_baslik: "ابطال تابعیت ترکیه در پرتو ادعاهای «بحران تابعیت» در استانبول: ارزیابی حقوقی",
            blog26_kisa: "ارزیابی حقوقی ادعاهای ابطال تابعیت در استانبول: دلایل ابطال، آثار حقوقی و راه‌های اعتراض.",
            blog26_icerik: "<h3>ابطال تابعیت ترکیه در پرتو ادعاهای «بحران تابعیت» در استانبول: ارزیابی حقوقی</h3><p>در روزهای اخیر، گزارش‌هایی در رسانه‌ها منتشر شده است مبنی بر اینکه تابعیت اتباع خارجی که از طریق خرید ملک در استانبول تابعیت ترکیه را به دست آورده‌اند، ممکن است لغو شود. این تحولات باعث شده است که موضوع <strong>ابطال و بازپس‌گیری تابعیت</strong> که در عمل نیز به‌کرات مطرح می‌شود، بار دیگر مورد بحث قرار گیرد.</p><p>در این نوشتار، ادعاهای مذکور را در <strong>چارچوب قانون تابعیت ترکیه</strong> از منظر حقوقی بررسی می‌کنیم.</p><h4>1. ابطال تابعیت ترکیه چیست؟</h4><p>در حقوق ترکیه، ابطال تابعیت معمولاً به معنای <strong>لغو تابعیتی است که بعداً و با تصمیم اداری به شخص اعطا شده است</strong>. بر اساس قانون شماره 5901 تابعیت ترکیه، تابعیت می‌تواند از طریق تولد یا به صورت اکتسابی (سرمایه‌گذاری، ازدواج، اقامت و غیره) به دست آید. با این حال، <strong>ابطال تنها در مورد تابعیت‌های اکتسابی امکان‌پذیر است</strong>.</p><h4>2. مبنای حقوقی: از دست دادن و ابطال تابعیت</h4><p>بر اساس قانون، از دست دادن تابعیت به سه شکل رخ می‌دهد:</p><ul><li>ترک تابعیت</li><li>سلب تابعیت</li><li>ابطال تصمیم اعطای تابعیت</li></ul><p>به‌ویژه، <strong>«ابطال تصمیم اعطای تابعیت»</strong> از بحث‌برانگیزترین موضوعات در عمل است.</p><h4>3. دلایل ابطال تابعیت</h4><h5>الف) ارائه اطلاعات یا اسناد خلاف واقع</h5><p>در جریان درخواست تابعیت، ارائه مدارک جعلی یا اطلاعات ناقص/نادرست می‌تواند منجر به <strong>ابطال تابعیت با اثر عطف به ماسبق</strong> شود.</p><h5>ب) عدم تحقق واقعی شرایط قانونی</h5><p>به‌ویژه در تابعیت از طریق سرمایه‌گذاری؛ کمتر بودن ارزش واقعی ملک از حد قانونی یا غیرواقعی بودن گزارش‌های کارشناسی در صورت کشف، امکان ابطال وجود دارد.</p><p>این موضوع اساس ادعاهای مطرح‌شده درباره «بحران تابعیت در استانبول» را نیز تشکیل می‌دهد.</p><h5>ج) ملاحظات نظم عمومی و امنیت ملی</h5><p>اداره می‌تواند در مواردی که شخص را تهدیدی برای نظم عمومی یا امنیت ملی بداند، تابعیت را لغو کند.</p><h4>4. آثار حقوقی ابطال تابعیت</h4><p>در صورت ابطال تابعیت:</p><ul><li>تابعیت ترکیه شخص <strong>به‌صورت عطف به ماسبق از بین می‌رود</strong></li><li>کارت شناسایی و گذرنامه بی‌اعتبار می‌شود</li><li>شخص مجدداً به وضعیت تبعه خارجی بازمی‌گردد</li><li>امکان آغاز روند اخراج از کشور وجود دارد</li></ul><p>همچنین در برخی موارد، فرآیندهای مربوط به تصفیه دارایی‌ها نیز ممکن است مطرح شود.</p><h4>5. آیا محدودیت زمانی وجود دارد؟</h4><p>نکته مهم: برای ابطال تابعیت در قانون، <strong>محدودیت زمانی مشخصی پیش‌بینی نشده است</strong>. بنابراین، حتی اگر دلایل ابطال سال‌ها بعد آشکار شود، امکان لغو تابعیت وجود دارد. این وضعیت برای افرادی که از طریق سرمایه‌گذاری تابعیت کسب کرده‌اند، یک ریسک جدی حقوقی محسوب می‌شود.</p><h4>6. راه‌های حقوقی اعتراض به ابطال تابعیت</h4><p>برای افرادی که تابعیت آن‌ها لغو شده است، مهم‌ترین تضمین، <strong>حق مراجعه به دادگاه</strong> است. این افراد می‌توانند:</p><ul><li>ظرف <strong>60 روز</strong> از تاریخ ابلاغ تصمیم</li><li>در دادگاه اداری <strong>دعوای ابطال</strong> مطرح کنند</li></ul><p>در این دعاوی، حدود اختیار اداری، وجود دلایل و مستندات کافی و حسن‌نیت سرمایه‌گذار نقش کلیدی دارند.</p><h4>7. بحث جاری: مسئله «سرمایه‌گذار با حسن‌نیت»</h4><p>یکی از مهم‌ترین مباحث حقوقی در گزارش‌های اخیر: آیا افرادی که با اعتماد به فرآیندهای تأییدشده دولتی سرمایه‌گذاری کرده‌اند، می‌توانند به دلیل خطاهایی که بعداً آشکار می‌شود، مسئول شناخته شوند؟</p><p>در این زمینه، آرای دیوان عالی اداری تأکید دارند که اختیار اداره <strong>نامحدود نیست</strong> و تصمیمات باید بر اساس دلایل عینی و مشخص اتخاذ شوند.</p><h4>8. نتیجه‌گیری و ارزیابی</h4><p>ادعاهای مطرح‌شده درباره ابطال تابعیت در استانبول، در واقع به یکی از حوزه‌های دیرینه مورد بحث در حقوق تابعیت ترکیه اشاره دارد:</p><ul><li>همان‌قدر که کسب تابعیت اهمیت دارد، <strong>حفظ آن نیز نیازمند تضمین حقوقی است</strong></li><li>به‌ویژه در تابعیت از طریق سرمایه‌گذاری، <strong>صحت ارزیابی‌ها و فرآیندهای اداری اهمیت حیاتی دارد</strong></li><li>امکان مراجعه مؤثر به دادگاه، <strong>مهم‌ترین ابزار احقاق حق است</strong></li></ul><p>بنابراین، افرادی که با خطر ابطال تابعیت مواجه هستند، باید حتماً از یک <strong>وکیل متخصص در حقوق اداری</strong> مشاوره دریافت کنند.</p>",

            sss: "سوالات رایج",
            sss_baslik: "سوالات متداول",
            sss_alt_baslik: "سوالات شما",
            sss_aciklama: "پاسخ سوالات رایج درباره فرآیندهای حقوقی را در زیر بیابید.",
            sss_cta_text: "پاسخ سوال خود را پیدا نکردید؟ با ما تماس بگیرید!",
            sss_genel: "سوالات عمومی",
            sss_bosanma: "حقوق طلاق و خانواده",
            sss_yabancilar: "حقوق اتباع خارجی و تابعیت",
            sss_is_hukuku: "حقوق کار",
            sss_kira: "حقوق املاک و اجاره",
            sss_miras: "حقوق ارث",
            sss_trafik: "حوادث رانندگی و جبران خسارت",
            sss_trafik_aciklama: "شهروندان ترکیه و اتباع خارجی از حقوق برابر برخوردارند و در حوادث رانندگی مقررات یکسانی اعمال می‌شود",
            sss_soru_1: "دامنه خدمات مشاوره آنلاین چیست؟",
            sss_cevap_1: "دفتر ما از طریق واتساپ، تلفن و ویدئو کنفرانس خدمات مشاوره حقوقی آنلاین ارائه می‌دهد. به ‌ویژه به موکلان خارج از کشور از این طریق خدمات بدون وقفه ارائه می‌گردد.",
            sss_soru_2: "آیا خدمات به زبان خارجی ارائه می‌دهید؟",
            sss_cevap_2: "در مجموعه ما وکلایی مسلط به زبان‌های فارسی و انگلیسی حضور دارند. به موکلان ایرانی و فارسی‌زبان، مشاوره حقوقی به زبان مادری‌شان ارائه می‌شود.",
            sss_soru_3: "هزینه مشاوره وکیل چقدر است؟",
            sss_cevap_3: "هزینه مشاوره بسته به نوع و پیچیدگی پرونده متفاوت است. سیاست شفافی در قیمت‌گذاری اعمال می‌شود. برای اطلاعات بیشتر قبل از جلسه اول با دفتر ما تماس بگیرید.",
            sss_soru_4: "رسیدگی به دعوای طلاق چقدر طول می‌کشد؟",
            sss_cevap_4: "دعاوی توافقی معمولاً ظرف ۱ تا ۳ ماه به نتیجه می‌رسند. دعاوی غیرتوافقی بسته به پیچیدگی پرونده و حجم کاری دادگاه بین ۱ تا ۳ سال طول می‌کشند.",
            sss_soru_5: "شرایط طلاق یک تبعه خارجی در ترکیه چیست؟",
            sss_cevap_5: "سکونت یکی از زوجین در ترکیه یا انجام ازدواج در ترکیه برای صلاحیت دادگاه کافی است. هنگام درخواست، اصل پاسپورت، سند ازدواج و در صورت وجود مدارک دارای آپوستیل لازم است.",
            sss_soru_6: "روند نفقه و حضانت چگونه است؟",
            sss_cevap_6: "در فرآیند طلاق، با در نظر گرفتن مصلحت کودک، تصمیم حضانت اتخاذ می‌شود. همچنین برای تأمین معیشت همسر و فرزندان، دادگاه می‌تواند حکم نفقه موقت، نفقه فقر یا نفقه فرزند صادر کند.",
            sss_soru_7: "روند اخذ اجازه کار چگونه است؟",
            sss_cevap_7: "درخواست‌ها از داخل کشور از طریق دولت الکترونیک (وزارت مربوطه) و از خارج کشور از طریق کنسولگری‌های ترکیه انجام می‌شود. این روند معمولاً بین ۳۰ تا ۶۰ روز طول می‌کشد.",
            sss_soru_8: "حداقل سرمایه برای اخذ تابعیت از طریق سرمایه‌گذاری چیست؟",
            sss_cevap_8: "خرید ملک حداقل به ارزش ۴۰۰٬۰۰۰ دلار، یا سرمایه‌گذاری ثابت ۵۰۰٬۰۰۰ دلار، یا سپرده‌گذاری ۵۰۰٬۰۰۰ دلار در بانک الزامی است. انجام این فرآیند بین ۶ ماه تا ۱ سال زمان می‌برد.",
            sss_soru_9: "برای اخذ اقامت چه مدارکی لازم است؟",
            sss_cevap_9: "بسته به نوع اقامت (کوتاه‌مدت، خانوادگی یا دانشجویی)، بیمه درمانی معتبر، اعلام محل سکونت و مدارک اثبات توان مالی ضروری است.",
            sss_soru_10: "حقوق کارگری که اخراج شده چیست؟",
            sss_cevap_10: "کارگری که حداقل ۱ سال کار کرده باشد، مستحق دریافت حق سنوات است. بسته به نوع فسخ قرارداد، می‌توان درخواست حق اخطار، اضافه‌کاری، حقوق مرخصی سالانه و خسارت سوءنیت نمود.",
            sss_soru_11: "دعوای خسارت مادی و معنوی پس از حادثه کار چگونه مطرح می‌شود؟",
            sss_cevap_11: "پس از تعیین حادثه توسط سازمان تأمین اجتماعی و مشخص شدن میزان تقصیر، می‌توان علیه کارفرما دعوای خسارت مطرح کرد.",
            sss_soru_12: "افزایش اجاره چگونه محاسبه می‌شود؟",
            sss_cevap_12: "افزایش اجاره مسکن نمی‌تواند از نرخ تورم سال گذشته (TÜFE) بیشتر باشد. طرفین می‌توانند نرخ کمتری تعیین کنند اما نمی‌توانند از حد قانونی تجاوز کنند. اجاره‌های تجاری متفاوت ارزیابی می‌شوند.",
            sss_soru_13: "در چه شرایطی دعوای تخلیه مطرح می‌شود؟",
            sss_cevap_13: "عدم پرداخت اجاره، نیاز مالک، پایان دوره تمدید ۱۰ ساله یا وجود تعهد تخلیه از جمله دلایل قانونی هستند.",
            sss_soru_14: "تعهدنامه تخلیه چیست و آیا معتبر است؟",
            sss_cevap_14: "تعهد کتبی مستأجر برای تخلیه ملک در تاریخ مشخص است. برای اعتبار، باید پس از قرارداد اجاره امضا شده باشد.",
            sss_soru_15: "مهلت مرور زمان در دعاوی ارث چیست؟",
            sss_cevap_15: "دعوای تعدیل (تنقیص): ۱ سال از زمان اطلاع و ۱۰ سال از زمان فوت. دعوای استحقاق: ۱ سال علیه افراد با حسن نیت و ۲۰ سال علیه افراد با سوءنیت.",
            sss_soru_16: "گواهی انحصار وراثت از کجا دریافت می‌شود؟",
            sss_cevap_16: "این سند از دفاتر اسناد رسمی یا دادگاه‌های حقوقی صلح قابل دریافت است. در موارد دارای عنصر خارجی باید از طریق دادگاه اقدام شود.",
            sss_soru_17: "مهلت رد ارث چقدر است؟",
            sss_cevap_17: "وراث می‌توانند ظرف ۳ ماه از تاریخ فوت، با مراجعه به دادگاه ارث را رد کنند.",
            sss_soru_18: "پس از تصادف چه خسارت‌هایی قابل مطالبه است؟",
            sss_cevap_18: "در صورت جراحت: هزینه درمان، خسارت ازکارافتادگی (موقت یا دائم) و خسارت معنوی. در صورت فوت: خسارت فقدان نان‌آور، هزینه‌های کفن و دفن و خسارت معنوی بستگان.",
            sss_soru_19: "خسارت کاهش ارزش خودرو چیست؟",
            sss_cevap_19: "شخص بدون تقصیر یا با تقصیر کم می‌تواند کاهش ارزش خودرو را از بیمه شخص ثالث طرف مقابل مطالبه کند. معمولاً باید ظرف ۲ سال اقدام شود.",
            sss_soru_20: "مرور زمان دعاوی تصادف چقدر است؟",
            sss_cevap_20: "به‌طور معمول ۲ سال از تاریخ حادثه است. اگر حادثه جرم محسوب شود، این مدت تا ۸ الی ۱۵ سال افزایش می‌یابد.",
            sss_soru_21: "چگونه به درصد تقصیر اعتراض کنیم؟",
            sss_cevap_21: "می‌توان از طریق مرکز اطلاعات بیمه (SBM) یا دادگاه تجاری اعتراض کرد.",
            sss_soru_22: "اگر شرکت بیمه خسارت را ناقص پرداخت کند چه باید کرد؟",
            sss_cevap_22: "می‌توان به کمیسیون داوری بیمه مراجعه یا دعوا طرح کرد.",
            sss_soru_23: "در صورت رانندگی در حالت مستی آیا بیمه پرداخت می‌کند؟",
            sss_cevap_23: "بیمه خسارت اشخاص ثالث را می‌پردازد، اما می‌تواند مبلغ را از راننده مقصر بازپس گیرد.",
            sss_soru_24: "آیا در تصادف بدون جراحت باید پلیس خبر شود؟",
            sss_cevap_24: "در صورت توافق طرفین، می‌توان گزارش را خودشان تنظیم کنند. در صورت جراحت یا خسارت عمومی، تماس با پلیس الزامی است.",
            sss_soru_25: "در تصادف فرار (نامشخص بودن مقصر) چه باید کرد؟",
            sss_cevap_25: "در صورت عدم شناسایی خودرو، برای خسارات جانی می‌توان به صندوق ضمانت مراجعه کرد.",
            blog_filtre_tumu: "همه",
            blog_filtre_yabancilar: "حقوق خارجی ها",
            blog_filtre_is: "حقوق کار",
            blog_filtre_kira: "حقوق اجاره",
            blog_filtre_miras: "حقوق ارث و میراث",
            blog_filtre_tuketici: "حقوق مصرف کننده",
            blog_filtre_bosanma: "حقوق طلاق",
            blog_filtre_saglik: "حقوق بهداشت",
            blog_filtre_tazminat: "حقوق جبران خسارت",
            blog_badge_yabancilar: "حقوق خارجی ها",
            blog_badge_is: "حقوق کار",
            blog_badge_kira: "حقوق اجاره",
            blog_badge_miras: "حقوق ارث و میراث",
            blog_badge_tuketici: "حقوق مصرف کننده",
            blog_badge_bosanma: "حقوق طلاق",
            blog_badge_saglik: "حقوق بهداشت",
            blog_badge_tazminat: "حقوق جبران خسارت",
            kvkk_text: "این وب سایت از کوکی ها برای بهبود تجربه شما استفاده می کند. با ادامه استفاده از سایت، سیاست کوکی ما را می پذیرید.",
            kvkk_kabul: "قبول",
            blog_onceki: "مقاله قبلی",
            blog_sonraki: "مقاله بعدی",
            blog_diger_yazilar: "مقالات دیگر",
        ...
        tr: {
            ...
            hero_ucretsiz_danismanlik: "Ücretsiz İlk Danışmanlık",
            hero_subtitle: "Ankara merkezli, Türkçe ve Farsça hizmet veren uzman hukuk bürosu",
            hero_whatsapp: "WhatsApp ile Yazın",
            yıl_deneyim: "Yıl Deneyim",
            uzman_avukat: "Uzman Avukat",
            hukuk_dalı: "Hukuk Dalı",
            dil_desteği: "Dil Desteği",
            hakkımızda_paragraf_1:"Hukuki faaliyetlerde 10 yılı aşkın tecrübeye sahip, her iki ülkenin mevcut yasalarına gerekli hakimiyete sahip, Türkiye ve İran'ın deneyimli avukatlarından oluşan Pehlivan&Güven Hukuk Bürosu olarak, hukuki danışmanlık almaya, sözleşmeler hazırlamaya ve kabul etmeye hazırız. Hem İran'ın hem de Türkiye'nin mahkemelerinde temsilimiz var.",
            ...
            ekibimiz_1: [
                "<div style='margin-bottom:12px'><div style='font-size:24px;font-weight:900;color:#111;line-height:1.2'>AYDIN GÜVEN</div><div style='font-size:16px;font-weight:400;color:#555;margin-top:2px'>Avukat - Yeminli Tercüman</div></div>",
            ...
            ekibimiz_tel_1: "<li><a href=\"tel:+90 0542 405 60 94\"><span class=\"align-middle\"><i class=\"ti-mobile\"></i></span>+90 0542 405 60 94</a></li>",
            ekibimiz_2: [
                "<div style='margin-bottom:12px'><div style='font-size:24px;font-weight:900;color:#111;line-height:1.2'>Abdurrahman PEHLİVAN</div><div style='font-size:16px;font-weight:400;color:#555;margin-top:2px'>Avukat - Arabulucu</div></div>",
            ...
            ekibimiz_3: [
                "<div style='margin-bottom:12px'><div style='font-size:24px;font-weight:900;color:#111;line-height:1.2'>Canan PEHLİVAN</div><div style='font-size:16px;font-weight:400;color:#555;margin-top:2px'>Avukat - Bilirkişi - Arabulucu</div></div>",
            ...
            Denklik_ve_Diploma_İptallerinde_Kazanılmış_Hak_ve_İdarenin_İşlemi_Geri_Alma_Yetkisi:"Denklik ve Diploma İptallerinde Kazanılmış Hak ve İdarenin İşlemi Geri Alma Yetkisi",
            Denklik_ve_Diploma_İptallerinde_Kazanılmış_Hak_ve_İdarenin_İşlemi_Geri_Alma_Yetkisi_kısa:"Yükseköğretim Kurulu (YÖK) tarafından son dönemde tesis edilen \"denklik iptali\" işlemleri, mülkiyet hakkından çalışma hürriyetine kadar pek çok anayasal hakkı doğrudan etkileyen bir boyuta ulaşmıştır.",
            Denklik_ve_Diploma_İptallerinde_Kazanılmış_Hak_ve_İdarenin_İşlemi_Geri_Alma_Yetkisi_uzun:
                [
                    "Yükseköğretim Kurulu (YÖK) tarafından son dönemde tesis edilen 'denklik iptali' işlemleri, mülkiyet hakkından çalışma hürriyetine kadar pek çok anayasal hakkı doğrudan etkileyen bir boyuta ulaşmıştır. Özellikle Payame Noor Üniversitesi (PNU) mezunlarını etkileyen bu süreçler; idare hukukunun temel direkleri olan 'hukuki güvenlik', 'idari istikrar' ve 'kazanılmış hak' ilkeleri çerçevesinde yargısal denetime tabidir.",
                    "<p></p>",
                    "İdarenin kendi tesis ettiği işlemleri geri alma yetkisi sınırsız değildir ve özellikle uzun yıllar sonra yapılan iptaller ciddi hukuka aykırılıklar barındırmaktadır.",
                    "<p></p>",
                    "<h6>1. İdarenin İşlemi Geri Alma Yetkisi ve 'Makul Süre' Sınırı</h6>",
                    "İdare, kural olarak hukuka aykırı olan işlemlerini her zaman geri alma yetkisine sahip değildir. Yerleşik Danıştay içtihatları ve doktrin, idarenin kendi hatasından kaynaklanan işlemlerini ancak dava açma süresi (60 gün) içerisinde geri alabileceğini kabul eder." ,
                    "<p></p>",
                    "Danıştay İçtihadı Birleştirme Kurulu’nun 22.12.1973 günlü, E:1968/8, K:1973/14 sayılı kararı uyarınca; idare, yokluk, hile veya açık hata halleri dışında, yararlandırıcı bir idari işlemi ancak dava açma süresi içinde geri alabilir. Bu süre geçtikten sonra işlemin geri alınması, 'idari istikrar' ilkesini zedeler.",
                    "<p></p>",
                    "<h6>2. Kazanılmış Hak (Müktesep Hak) ve Hukuki Güvenlik</h6>",
                    "Bir denklik belgesi, ilgiliye akademik ve mesleki bir statü kazandıran \"yararlandırıcı işlem\" mahiyetindedir. Kişinin herhangi bir hilesi veya gerçeğe aykırı beyanı olmaksızın, YÖK tarafından yapılan inceleme sonucu verilen bu belge, üzerinden makul süre geçmesiyle birlikte kazanılmış hak doğurur.",
                    "<p></p>",
                    "Hukuki güvenlik ilkesi, bireylerin hukuk sistemine duyduğu güvenin korunmasını gerektirir. Yıllar önce verilmiş bir denkliğe dayanarak yüksek lisans yapan, kamuda görev alan veya serbest meslek icra eden bir bireyin; idarenin yıllar sonra değişen görüşüyle tüm kariyerinin sıfırlanması, hukuk devleti ilkesiyle bağdaşmaz.",
                    "<p></p>",
                    "<h6>3. Geri Alma Yetkisinin İstisnaları: Hile ve Açık Hata</h6>",
                    "İdarenin zamana bağlı olmaksızın işlemi geri alabileceği iki durum mevcuttur:",
                    "<strong>1. Hile ve Tesis:</strong> İlgilinin sahte belge sunması veya idareyi yanıltması durumunda süre aranmaz.",
                    "<strong>2. Açık Hata:</strong> İşlemin tesisinde herkes tarafından görülebilecek kadar bariz bir yanlışlık olması durumudur. Ancak, mevzuatın yorumlanmasındaki farklılıklar veya 'eğitim modelinin uygunluğu' gibi subjektif değerlendirmeler açık hata kapsamında değerlendirilemez.",
                    "<p></p>",
                    "<h6>4. Payame Noor Üniversitesi Kararları ve Hukuki Analiz</h6>",
                    "YÖK’ün PNU mezunları hakkında verdiği iptal kararlarında sıklıkla 'eğitimin açık öğretim modelinde yapıldığının sonradan tespiti' gerekçesi sunulmaktadır. Ancak:",
                    "<strong>1.</strong> Üniversitenin eğitim modeli denklik verilirken idarenin incelemesine tabi tutulmuşsa,",
                    "<strong>2.</strong> Diploma eklerinde eğitim türü açıkça belirtilmişse,",
                    "<strong>3.</strong> İlgili kişi tüm belgelerini eksiksiz sunduysa,",
                    "ortada bir 'hile'den veya 'açık hata'dan söz edilemez. Burada söz konusu olan, idarenin geçmişteki takdir yetkisini bugün farklı kullanma arzusudur ki; bu durum geriye yürütme yasağına aykırıdır.",
                    "<p></p>",
                    "<h6>5. Yargı Kararları Işığında Değerlendirme</h6>",
                    "Danıştay ve Anayasa Mahkemesi, bireyin üzerine düşen yükümlülükleri yerine getirdiği ve idarenin denetim süzgecinden geçerek hak kazandığı durumlarda, idarenin kendi kusurunu bireye yüklemesini hukuka aykırı bulmaktadır.",
                    "<strong>✦ Zaman Aşımı:</strong> Denklik işleminin üzerinden 10, 20 veya 30 yıl gibi uzun süreler geçtikten sonra yapılan iptaller, Avrupa İnsan Hakları Sözleşmesi bağlamında 'özel hayata saygı' ve 'mülkiyet hakkı' ihlali olarak değerlendirilmektedir.",
                    "<strong>✦ İdari Sadakat:</strong> İdare, vatandaşlarına karşı dürüst davranmak ve yarattığı hukuki sonuçlara sadık kalmak zorundadır.",
                    "<p></p>",
                    "<h6>Sonuç</h6>",
                    "Denklik iptalleri, sadece bir belgenin geri alınması değil; bir bireyin geçmişinin, emeğinin ve geleceğinin iptal edilmesidir. Payame Noor Üniversitesi veya benzeri yurt dışı kurumlarından mezun olup denklik iptali ile karşı karşıya kalan kişilerin, işlemin tebliğinden itibaren yasal süreler içerisinde <strong>Yürütmeyi Durdurma</strong> istemli iptal davası açmaları hayati önem taşımaktadır.",
                    "<p></p>",
                    "Unutulmamalıdır ki; idarenin her türlü eylem ve işlemi yargı denetimine tabi olup, 'kazanılmış haklar' anayasal güvence altındadır.",
            ],

            Fazla_Mesai_ve_Fazla_Sürelerle_Çalışma_Ücretinin_Hesaplanması:"Fazla Mesai ve Fazla Sürelerle Çalışma Ücretinin Hesaplanması",
            Fazla_Mesai_ve_Fazla_Sürelerle_Çalışma_Ücretinin_Hesaplanması_kısa:"Fazla mesai ve fazla sürelerle çalışmanın hesaplanması, ödenmesi ve ispatlanması süreçleri, 4857 sayılı İş Kanunu ve ilgili yönetmelikler çerçevesinde düzenlenmiştir.",
            Fazla_Mesai_ve_Fazla_Sürelerle_Çalışma_Ücretinin_Hesaplanması_uzun:
                [
                    ...
                    "<h6>A. Hesaplama Oranları ve Süreler</h6>",

                    "<strong>1. Fazla Çalışma Ücreti</strong>",
                    "<strong>✦ Tanımı:</strong> Kanunda yazılı koşullar çerçevesinde, haftalık kırk beş saati aşan çalışmalar fazla çalışmadır.",
                    "<strong>✦ Ücreti:</strong> Her bir saat fazla çalışma için ödenecek ücret, normal çalışma ücretinin saat başına düşen miktarının yüzde elli (%50) yükseltilmesi suretiyle ödenir.",
                    "<p></p>",

                    "<strong>2. Fazla Sürelerle Çalışma Ücreti</strong>",
                    "<strong>✦ Tanımı:</strong> Haftalık çalışma süresinin sözleşmelerle kırk beş saatin altında belirlendiği durumlarda, ortalama haftalık çalışma süresini aşan ve kırk beş saate kadar yapılan çalışmalar fazla sürelerle çalışmadır.",
                    "<strong>✦ Ücreti:</strong> Her bir saat fazla sürelerle çalışma için ödenecek ücret, normal çalışma ücretinin saat başına düşen miktarının yüzde yirmi beş (%25) yükseltilmesiyle ödenir.",
                    "<strong>✦ </strong> Tarafların anlaşmasıyla fazla sürelerle çalışma ücreti, fazla çalışma ücreti (yüzde elli zamlı miktar) ile eş değer hale getirilebilir.",
                    "<p></p>",

                    "<strong>3. Yer Altı Maden İşlerinde Fazla Çalışma</strong>",
                    "<strong>✦</strong> Yer altı maden işlerinde haftalık çalışma süresi en çok otuz yedi buçuk saattir.",
                    "<strong>✦</strong> Bu sürenin aşılması halinde her bir saat fazla çalışma için verilecek ücret, normal çalışma ücretinin saat başına düşen miktarının yüzde yüzden (%100) az olmamak üzere artırılması suretiyle ödenir.",
                    "<p></p>",

                    "<h6>B. Hesaplamada Esas Alınan Ücret ve Süreler</h6>",
                    "<strong>✦ Ücret Türü:</strong> Fazla çalışma ücretinin hesaplanmasında işçinin saat başına düşen çıplak brüt ücreti esas alınır. Giydirilmiş brüt ücret veya net ücret üzerinden hesaplama yapılması Yargıtay kararlarında bozma sebebi olarak kabul edilmektedir.",
                    "<strong>✦ Dönem Ücreti:</strong> Hesaplamada esas alınacak ücret, işçinin aldığı son ücret değil, fazla çalışmanın yapıldığı döneme ait ücrettir.",
                    "<strong>✦ Yuvarlama Kuralı:</strong> Yarım saatten az süreler yarım saat, yarım saati aşan süreler ise bir saat olarak kabul edilir.",
                    "<strong>✦ Günlük Maksimum Sınır:</strong> Fazla çalışmalar dahil olmak üzere günlük çalışma süresi on bir saati aşamaz.",
                    "<strong>✦ Yıllık Maksimum Sınır:</strong> Genel sebeplerle yapılan fazla çalışma süresi yılda iki yüz yetmiş saati geçemez. Bu sınır aşılsa dahi yapılan çalışmaların ücreti ödenmelidir.",
                    "<p></p>",

                    "<h6>C. Özel Çalışma Şekillerinde Hesaplama</h6>",
                    "<strong>✦ Hafta Tatili Çalışması:</strong> İşçi hafta tatilinde çalıştırılırsa, çalışmadan hak kazandığı bir günlük ücretine ek olarak, çalışmasının karşılığı olarak yüzde elli zamlı ücret (1,5 günlük ücret) ödenmesi gerekir, bu da toplamda 2,5 günlük ücrete denk gelir.",
                    "<strong>✦ Ara Dinlenmesinde Çalışma:</strong> Ara dinlenmesinde işçinin işverenin talimatıyla işin başında bulundurulması veya çalıştırılması durumunda, bu süre çalışma süresinden sayılır ve haftalık 45 saati aşarsa fazla çalışma ücretine hak kazanılır.",
                    "<strong>✦ Prim ve Yüzde Usulü Ücret:</strong> Yüzde usulü ücret alan işçilerde, fazla çalışmanın zamsız karşılığı yüzdelerden ödenir; zamlı kısım (%50 veya %25 fark) ise işveren tarafından ödenir. Prim alan işçilerde ise Yargıtay, primin fazla çalışmanın normal saat ücretini karşıladığı kabul edilerek, sadece %50 fazlasının fazla çalışma olarak hesaplanması gerektiği görüşünü benimsemektedir.",
                    "<p></p>",

                    "<h6>2. Fazla Mesai ve Fazla Sürelerle Çalışma Ücretinin Ödenmesi ve Karşılığı</h6>",
                    ...
                    "<strong>A. Ücret ve Faiz</strong>",
                    "<strong>✦ Ödeme Şekli:</strong> Fazla çalışma ücretleri, normal çalışma ücretleriyle birlikte, ücret bordrolarında ve işçiye verilmesi gereken ücret hesap pusulalarında açıkça gösterilerek ödenir.",
                    "<strong>✦ Faiz:</strong> Fazla çalışma ücreti bir ücret alacağı olduğundan, İş Kanunu m. 34 uyarınca, mevduata uygulanan en yüksek faiz oranı uygulanır. İşveren daha önce temerrüde düşürülmemişse, faiz başlangıcı kural olarak dava tarihidir. Ancak zorunlu arabuluculuk sürecinde, işverenin temerrüde düşürülmediği durumlarda arabulucuya başvuru tarihi faiz başlangıcı olarak kabul edilmelidir.",
                    "<p></p>",

                    "<strong>B. Serbest Zaman Uygulaması</strong>",
                    "<strong>✦ Karşılıkları:</strong> İşçi isterse, zamlı ücret yerine serbest zaman kullanabilir.",
                    "<strong>o</strong> Fazla çalıştığı her saat karşılığında bir saat otuz dakika (1,5 saat) serbest zaman.",
                    "<strong>o</strong> Fazla sürelerle çalıştığı her saat karşılığında bir saat on beş dakika (1,25 saat) serbest zaman.",
                    "<p></p>",
                    "<strong>✦ Kullanım:</strong> İşçi hak ettiği serbest zamanı, altı ay zarfında, çalışma süreleri içinde ve ücretinde bir kesinti olmadan kullanır. İşçi, bu talebini işverene önceden yazılı olarak bildirmelidir.",
                    "<strong>✦ Serbest Zamanın Sınırları:</strong> Zorunlu ve olağanüstü sebeplerle yapılan fazla çalışmalarda işçi, artırılmış ücret hakkından vazgeçip serbest zaman talebinde bulunamaz.",
                    "<strong>✦ Kullanılmaması:</strong> Eğer işçi altı aylık süre zarfında serbest zamandan yararlanamazsa veya sözleşmesi bitirilirse, kendisine fazla çalışma bedeli olan ücretin ödenmesi gerekir.",
                    "<p></p>",

                    "<h6>3. Fazla Çalışma ve Fazla Sürelerle Çalışmanın İspatı ve Belgelenmesi</h6>",
                    "Fazla çalışmanın ispatı, işçi ve işveren için farklı yükümlülükler içerir.",
                    "<p></p>",
                    "<strong>A. Belgelendirme Yükümlülüğü</strong>",
                    ...
                    "<p></p>",
                    "<strong>B. İspat Yükü</strong>",
                    "<strong>✦ İşçi Yükümlülüğü:</strong> Fazla çalışma yaptığını iddia eden işçi, bu iddiasını ispatla yükümlüdür. İşçi, fazla çalışmasını tanık veya diğer deliller ile ispatlayabilir.",
                    "<strong>✦ İşveren Yükümlülüğü:</strong> Fazla çalışmanın ücretinin ödendiği iddiasını ise işveren ispatlamakla mükelleftir. Bu ispat genellikle ücret bordroları ve hesap pusulaları ile sağlanır.",
                    "<strong>✦ Bordroların Rolü:</strong> ",
                    "<strong>o</strong> İşçinin imzasını taşıyan bordro, sahteliği ispat edilinceye kadar kesin delil niteliğindedir.",
                    "<strong>o</strong> İmzasız bordrolarda veya bordronun fazla çalışma bölümünün boş olması halinde işçi fazla çalışmayı her türlü delille ispat edebilir.",
                    "<p></p>",
                    "<strong>C. Karineye Dayalı Makul İndirim (Hakkaniyet İndirimi)</strong>",
            ...
            Gece_Çalışmasında_Fazla_Mesai:"Gece Çalışmasında Fazla Mesai (Fazla Saatlerle Çalışma)",
            Gece_Çalışmasında_Fazla_Mesai_kısa:"Elbette, gece çalışmasında fazla mesai konusu, işçi sağlığını koruma ilkesi doğrultusunda özel düzenlemeler içermektedir ve bu kurallar, fazla çalışmanın genel hükümlerinden farklılık arz eder.",
            Gece_Çalışmasında_Fazla_Mesai_uzun:
                [
                    "Elbette, gece çalışmasında fazla mesai konusu, işçi sağlığını koruma ilkesi doğrultusunda özel düzenlemeler içermektedir ve bu kurallar, fazla çalışmanın genel hükümlerinden farklılık arz eder.",
                    "<p></p>",
                    "Aşağıda, kaynaklarınızda yer alan bilgiler doğrultusunda, gece çalışmasında fazla mesai (fazla saatlerle çalışma) konusunun hesaplanması ve sınırları detaylandırılmıştır:",
                    "<p></p>",
                    "<h6>1. Gece Döneminin Tanımı ve Çalışma Süresi</h6>",
                    "4857 sayılı İş Kanunu'na göre, çalışma hayatında \"gece\" en geç saat 20.00'de başlayarak en erken saat 06.00'ya kadar geçen ve her halde en fazla on bir saat süren dönemdir.",
                    "<p></p>",
                    "Gece dönemine ilişkin temel kural, İş Kanunu m. 69/3 uyarınca, işçilerin gece çalışmaları yedibuçuk saati (7,5 saat) geçemez hükmüdür.",
                    "<p></p>",
                    "Postalar halinde (vardiyalı) işçi çalıştırılan işlerde ise, çalışmanın yarısından çoğunun gece dönemine rastlaması durumunda, o postanın çalışması gece çalışması sayılmaktadır.",
                    "<p></p>",
                    "<h6>2. Fazla Çalışma Sınırı ve İstisnaları</h6>",
                    "Gece çalışmasında 7,5 saatlik süre, günlük çalışmanın, dolayısıyla fazla çalışmanın üst sınırını belirler. Bu sınır, haftalık kırk beş saatlik yasal çalışma süresi aşılmamış olsa dahi uygulanır; yani gece çalışması 7,5 saati aştığı anda, aşan kısım için fazla çalışma ücreti ödenmesi gerekir.",
                    "<p></p>",
                    "Bu kuralın iki temel istisnası bulunmaktadır:",
                    "<strong>1. Zorunlu ve Olağanüstü Sebeplerle Çalışma: </strong> Gece çalışmasında 7,5 saatlik sınır, genel (olağan) sebeplerle yapılan fazla çalışmalar için geçerlidir. İş Kanunu m. 42'de düzenlenen zorunlu nedenlerle ya da İş Kanunu m. 43'te düzenlenen olağanüstü nedenlerle fazla çalışma durumunda, gece döneminde dahi 7,5 saati aşan fazla çalışma uygulanması mümkündür.",
                    "<strong>2. Özel Hizmet Alanları (Yazılı Onayla): </strong> Turizm, özel güvenlik ve sağlık hizmeti yürütülen işlerde, işçinin yazılı onayının alınması şartıyla, 7,5 saatin üzerinde gece çalışması yaptırılabilir.",
                    "<strong>o </strong> Bu özel hizmet alanlarında, işçi yazılı onay vermişse, onay verilen süre aşılmadığı sürece 7,5 saati aşan bu çalışmalar fazla çalışma ücretine hak kazandırmaz.",
                    "<strong>o </strong> Ancak, işçi yazılı onay vermediği takdirde, 7,5 saati aşan bu çalışmalar için fazla çalışma ücreti talep edebilir.",
                    "<p></p>",
                    "<h6>3. Gece Çalışmasında Fazla Mesai Ücretinin Hesaplanması</h6>",
                    "Gece çalışmalarında 7,5 saatlik süreyi aşan çalışmalar için fazla çalışma ücreti hesaplanırken dikkat edilmesi gereken hususlar:",
                    "<strong>✦ Zam Oranı: </strong> Gece çalışmasının 7,5 saati aşan kısmı fazla çalışma niteliğindedir. Eğer haftalık 45 saatlik sınır aşılmamışsa, fazla çalışmanın normal (zamsız) kısmı aylık ücret içinde ödenmiş kabul edildiğinden, işçiye bu aşan süreler için sadece yüzde elli (%50) zamlı kısım ödenmelidir.",
                    "<strong>✦ Vardiyalı Çalışmada Farklı Hesaplama (Yargıtay Uygulaması): </strong> 24 saat çalışıp 24 saat veya 48 saat dinlenme gibi özel çalışma sistemlerinde (örneğin itfaiye erlerinde), Yargıtay'ın yerleşik uygulamasına göre, 7,5 saatlik gece çalışması sınırı yerine günlük 11 saatlik azami çalışma süresi esas alınmaktadır. Bu tür sistemlerde, günlük 11 saati aşan çalışmalar fazla çalışma olarak kabul edilir ve gece fazla çalışması kabul edilmemektedir. Ancak bazı akademisyenler, çalışmanın çoğunun geceye denk gelmesi durumunda 7,5 saatlik sınırın esas alınmasının daha isabetli olacağını savunmaktadır.",
                    "<p></p>",
                    "<h6>4. Fazla Çalışma Yasağı Olan Kişiler</h6>",
                    "Gece çalışması bağlamında bazı işçi grupları için daha katı kısıtlamalar mevcuttur:",
                    "<strong>✦ Çocuk ve Genç İşçiler: </strong> 18 yaşını doldurmamış işçilerin İş Kanunu'nda belirtilen gece döneminde (20.00-06.00) çalıştırılmaları yasaktır. Bu kişilere zaten genel olarak fazla çalışma yaptırılamaz.",
                    "<strong>✦ Gebe ve Emziren Kadınlar: </strong> Gebe veya emziren çalışanlar günde 7,5 saatten fazla çalıştırılamazlar. Ayrıca gebe ya da emziren kadın çalışanların doğumdan itibaren belirli bir süre boyunca (genellikle bir yıl) gece postalarında çalıştırılmaları da yasaktır. Bu kişilere genel olarak fazla çalışma da yaptırılamaz.",
                    "Özetle, gece çalışmasında kural, haftalık 45 saati doldurmamış olsa bile, 7,5 saati aşan her bir saatin fazla çalışma olarak kabul edilip en az %50 zamlı ödenmesidir, istisnai durumlar ve yasal yasaklar saklı kalmak kaydıyla.",
                ],
            ...
            blog25_baslik: "Trafik Kazası Sonrası Maddi ve Manevi Tazminat Rehberi",
            blog25_icerik: "<h3>Trafik Kazası Sonrası Maddi ve Manevi Tazminat Rehberi: Haklar, Hesaplamalar ve Yasal Süreç</h3><p>Trafik kazaları, hukuk sistemimizde <strong>\"haksız fiil\"</strong> sorumluluğu kapsamında değerlendirilen ve mağdurlar üzerinde ağır ekonomik ve psikolojik etkiler bırakan olaylardır. Bir kaza sonrası hak kaybına uğramamak için tazminat türlerinden teknik hesaplama yöntemlerine kadar sürecin tüm detaylarına hakim olmak büyük önem taşır.</p><h4>1. Trafik Kazası Tazminat Davasının Hukuki Niteliği</h4><p>Trafik kazası nedeniyle tazminat davası, en az bir motorlu aracın karıştığı kazada meydana gelen bedensel zararlar (ölüm, yaralanma) veya malvarlığı zararlarının giderilmesi amacıyla açılır. Bu davalar temelini Türk Borçlar Kanunu'nun 49. maddesinden ve 2918 sayılı Karayolları Trafik Kanunu'ndan alır.</p><h5>Dava Kimlere Karşı Açılabilir?</h5><ul><li><strong>Aracın Sürücüsü:</strong> Kazada kusuru bulunan kişi.</li><li><strong>Araç Sahibi ve İşleten:</strong> Trafik sicilinde malik görünen kişi karine olarak işleten sayılır ve zarardan müştereken ve müteselsilen sorumludur.</li><li><strong>Sigorta Şirketi:</strong> Aracın Zorunlu Mali Sorumluluk Sigortası (Trafik Sigortası) veya Kasko poliçesini yapan kurum.</li><li><strong>Güvence Hesabı:</strong> Sigortası bulunmayan veya faili meçhul araçların neden olduğu bedensel zararlarda başvurulacak mercidir.</li></ul><h4>2. Tazminat Türleri ve Kapsamı</h4><h5>A. Sürekli ve Geçici İş Göremezlik (Sakatlık) Tazminatı</h5><p>Beden tamlığının zedelenmesi sonucu kişinin çalışma gücünde oluşan azalmanın telafisidir.</p><ul><li><strong>Geçici İş Göremezlik:</strong> Tedavi süresince kişinin çalışamadığı dönemi kapsar ve bu sürede sakatlık oranı %100 kabul edilerek hesaplama yapılır.</li><li><strong>Sürekli İş Göremezlik:</strong> Tedavi sonunda kalıcı bir sakatlık (maluliyet) oluşması durumunda, kişinin hayatı boyunca uğrayacağı kazanç kaybıdır. Sakatlık oranı Adli Tıp Kurumu veya yetkili kurul raporları ile belirlenmelidir.</li></ul><h5>B. Destekten Yoksun Kalma Tazminatı (Ölümlü Kazalar)</h5><p>Bu tazminat türü, ölenin sağlığında fiilen ve düzenli olarak maddi destek sağladığı kişilerin (eş, çocuk, anne-baba vb.), bu yardımın sona ermesi nedeniyle uğradıkları ekonomik kaybı gidermeyi amaçlayan özel bir <strong>\"yansıma zarar\"</strong> türüdür.</p><ul><li><strong>Destek Kavramı:</strong> Sadece kanuni bir yükümlülüğe değil, fiili bir bakım ilişkisine dayanır.</li><li><strong>Farazi Destek:</strong> Küçük çocukların ölümü halinde, ileride anne ve babalarına bakacakları varsayılarak bu tazminata hükmedilir.</li></ul><h5>C. Araç Değer Kaybı Tazminatı</h5><p>Kazada zarar gören aracın onarılmış olsa dahi, kazadan önceki ikinci el piyasa değeri ile kazadan sonraki değeri arasındaki farktır.</p><h5>D. Manevi Tazminat</h5><p>Kaza nedeniyle duyulan elem, keder ve üzüntünün dindirilmesi amacıyla istenir. Mahkeme; tarafların sosyal ve ekonomik durumunu, kusur oranlarını ve olayın ağırlığını dikkate alarak \"hakkaniyete\" uygun bir miktar belirler.</p><h4>3. Tazminat Nasıl Hesaplanır? (Teknik Detaylar)</h4><ul><li><strong>Yaş ve Çalışma Süresi:</strong> Kişinin 18-65 yaş arası aktif, 65-72 yaş arası pasif çalışma döneminde olduğu kabul edilir.</li><li><strong>Gelir Durumu:</strong> Resmi belgeli net gelir esas alınır; belge yoksa asgari ücret üzerinden hesaplama yapılır.</li><li><strong>Hayat Tabloları:</strong> Gelecekteki yaşam süresi hesaplanırken TRH-2010 veya PMF tabloları ile %1,65 iskonto oranı kullanılır.</li><li><strong>Kusur ve Mahsup:</strong> Hesaplanan miktardan, mağdurun kendi kusuru oranında indirim yapılır. Ayrıca SGK tarafından bağlanan gelirlerin peşin sermaye değeri tazminattan düşülür.</li></ul><h4>4. Özel Durumlar: Yabancı Uyruklu Mağdurlar</h4><p>Türkiye'de kaza yapan yabancı uyruklu kişiler de tazminat hakkına sahiptir. Bu durumda tazminat Türkiye'deki asgari ücret üzerinden değil, mağdurun kendi ülkesindeki yaşam standartları ve gelir belgeleri dikkate alınarak hesaplanmalıdır.</p><h4>5. Kritik Süreler ve Başvuru Zorunluluğu</h4><ul><li><strong>Sigortaya Başvuru Şartı:</strong> Dava açmadan önce sigorta şirketine yazılı başvuruda bulunmak yasal bir zorunluluktur.</li><li><strong>Zamanaşımı:</strong> Zararın ve failin öğrenilmesinden itibaren 2 yıl, her halükarda kaza gününden itibaren 10 yıldır. Ancak kaza bir suç teşkil ediyorsa, daha uzun olan ceza zamanaşımı süreleri (8 ila 15 yıl) uygulanır.</li></ul><hr><h4>Trafik Kazası Tazminat Süreci Hakkında Sıkça Sorulan Sorular</h4><p><strong>1. Trafik kazası sonrası tazminat davası açmak için ne kadar sürem var?</strong><br>Trafik kazalarında zamanaşımı süresi, zararın ve failin öğrenildiği tarihten itibaren 2 yıl ve her halükarda kaza gününden itibaren 10 yıldır. Ancak kaza bir suç teşkil ediyorsa, ceza zamanaşımı süreleri (8 ile 15 yıl arası) uygulanır.</p><p><strong>2. Kazada hayatını kaybeden kişinin yakınları hangi tazminatları isteyebilir?</strong><br>Ölümlü kazalarda yakınlar; cenaze ve defin giderlerini, tedavi giderlerini ve destekten yoksun kalma tazminatını talep edebilirler. Ayrıca manevi tazminat davası açma hakları da mevcuttur.</p><p><strong>3. \"Destekten Yoksun Kalma\" tazminatını sadece yasal mirasçılar mı alabilir?</strong><br>Hayır. Ölen kişiden sağlığında fiilen ve düzenli olarak maddi destek alan herkes bu tazminatı isteyebilir.</p><p><strong>4. Aracım tamir edildiği halde piyasa değerinin düştüğünü düşünüyorum, ne yapmalıyım?</strong><br>\"Araç Değer Kaybı\" tazminatı talep edebilirsiniz. Aracın kazadan önceki rayiç değeri ile tamir sonrası değeri arasındaki fark sigorta şirketi tarafından karşılanmak zorundadır.</p><p><strong>5. Kazada benim de kusurum varsa tazminat alabilir miyim?</strong><br>Evet, ancak alacağınız tazminat miktarı kusurunuz oranında indirime tabi tutulur.</p><p><strong>6. Tazminat davası açmadan önce sigorta şirketine başvurmak zorunlu mu?</strong><br>Evet, 2918 sayılı Karayolları Trafik Kanunu uyarınca dava açmadan önce ilgili sigorta şirketine yazılı başvuruda bulunulması yasal bir zorunluluktur.</p><p><strong>7. Türkiye'de kaza yapan bir yabancı uyruklu kişi tazminat alabilir mi?</strong><br>Evet, yabancı uyruklular da bedensel zararları için tazminat talep edebilirler. Tazminat hesaplanırken mağdurun kendi ülkesindeki gelir belgeleri ve yaşam standartları esas alınmalıdır.</p><p><strong>8. Sigorta şirketi ödemeyi ne kadar sürede yapmak zorundadır?</strong><br>Gerekli tüm belgeler teslim edildikten sonra, sigortacı 8 iş günü içinde tazminatı ödemekle yükümlüdür.</p><p><strong>9. Tazminat miktarı belirlenirken mağdurun yaşı neden önemlidir?</strong><br>Tazminat hesaplamalarında mağdurun ne kadar süre daha çalışıp kazanç elde edebileceği (aktif ve pasif dönem) baz alınır.</p><hr><p><em><strong>Not:</strong> Trafik kazası tazminat hesaplamaları aktüerya uzmanlığı gerektiren teknik bir süreçtir. Hak kaybına uğramamak için bir avukattan profesyonel yardım almanız önemlidir.</em></p>",
            blog25_kisa: "Trafik kazası sonrası maddi ve manevi tazminat hakları, hesaplama yöntemleri ve yasal süreç rehberi.",

            blog26_baslik: "İstanbul'daki Vatandaşlık Krizi İddiaları ve Türk Vatandaşlığının İptali",
            blog26_kisa: "İstanbul'daki vatandaşlık krizi iddiaları ışığında Türk vatandaşlığının iptali: hukuki değerlendirme, iptal sebepleri ve hukuki yollar.",
            blog26_icerik: "<h3>İstanbul'daki \"Vatandaşlık Krizi\" İddiaları Işığında Türk Vatandaşlığının İptali: Hukuki Değerlendirme</h3><p>Son günlerde basına yansıyan haberlerde, özellikle İstanbul'da taşınmaz edinimi yoluyla Türk vatandaşlığı kazanan yabancı yatırımcıların vatandaşlıklarının iptal edilebileceğine ilişkin iddialar gündeme gelmiştir. Bu gelişmeler, uygulamada sıkça karşılaşılan <strong>vatandaşlığın iptali ve geri alınması</strong> süreçlerinin yeniden tartışılmasına neden olmuştur.</p><p>Bu yazımızda, söz konusu iddiaları <strong>Türk Vatandaşlığı Kanunu çerçevesinde</strong> hukuki açıdan ele alıyoruz.</p><h4>1. Türk Vatandaşlığının İptali Nedir?</h4><p>Türk hukukunda vatandaşlığın iptali, genellikle <strong>sonradan kazanılmış vatandaşlığın idari kararla geri alınması</strong> anlamına gelir. 5901 sayılı Türk Vatandaşlığı Kanunu uyarınca vatandaşlık; doğumla veya sonradan (yatırım, evlilik, ikamet vb.) kazanılabilir. Ancak <strong>iptal yalnızca sonradan kazanılan vatandaşlıklar için söz konusudur</strong>.</p><h4>2. Hukuki Dayanak: Vatandaşlığın Kaybı ve İptali</h4><p>Kanuna göre vatandaşlığın kaybı üç şekilde gerçekleşebilir:</p><ul><li>Çıkma</li><li>Kaybettirme</li><li>Vatandaşlığa alınma kararının iptali</li></ul><p>Özellikle <strong>vatandaşlığa alınma kararının iptali</strong>, uygulamada en çok tartışma yaratan başlıktır.</p><h4>3. Vatandaşlığın İptal Edilme Sebepleri</h4><h5>a) Gerçeğe aykırı beyan ve belge</h5><p>Vatandaşlık başvurusu sırasında sahte belge sunulması veya eksik/yanlış bilgi verilmesi halinde vatandaşlık kararı <strong>geriye etkili olarak iptal edilebilir</strong>.</p><h5>b) Şartların gerçekte sağlanmaması</h5><p>Özellikle yatırım yoluyla vatandaşlıkta; taşınmaz değerinin gerçekte yasal sınırın altında olması veya ekspertiz raporlarının gerçeği yansıtmaması gibi durumlar sonradan tespit edilirse iptal gündeme gelebilir.</p><p>Bu durum, basına yansıyan \"İstanbul vatandaşlık krizi\" iddialarının da temelini oluşturmaktadır.</p><h5>c) Kamu düzeni ve milli güvenlik gerekçeleri</h5><p>İdare, kamu düzeni veya milli güvenlik açısından risk gördüğü durumlarda da vatandaşlık kararını geri alabilir.</p><h4>4. İptal Kararının Hukuki Sonuçları</h4><p>Vatandaşlığın iptal edilmesi halinde:</p><ul><li>Kişinin Türk vatandaşlığı <strong>geriye etkili olarak ortadan kalkar</strong></li><li>Kimlik ve pasaport geçersiz hale gelir</li><li>Kişi tekrar yabancı statüsüne düşer</li><li>Sınır dışı süreci gündeme gelebilir</li></ul><p>Ayrıca bazı durumlarda malvarlığına ilişkin tasfiye süreçleri de söz konusu olabilir.</p><h4>5. Süre Sınırı Var mı?</h4><p>Önemli bir husus: Vatandaşlığın iptali için <strong>kanunda belirli bir süre sınırı öngörülmemiştir</strong>. Dolayısıyla, iptal sebepleri yıllar sonra ortaya çıksa bile vatandaşlık geri alınabilir. Bu durum, yatırım yoluyla vatandaşlık kazanan kişiler açısından ciddi bir hukuki risk doğurmaktadır.</p><h4>6. Vatandaşlık İptaline Karşı Hukuki Yollar</h4><p>Vatandaşlığı iptal edilen kişiler için en önemli güvencelerden biri <strong>yargı yoludur</strong>. İlgili kişiler:</p><ul><li>Kararın tebliğinden itibaren <strong>60 gün içinde</strong></li><li>İdare Mahkemesi'nde <strong>iptal davası açabilir</strong></li></ul><p>Bu davalarda; idarenin takdir yetkisinin sınırları, somut delil olup olmadığı ve iyi niyetli yatırımcı olup olunmadığı gibi hususlar kritik rol oynar.</p><h4>7. Güncel Tartışma: \"İyi Niyetli Yatırımcı\" Sorunu</h4><p>Son dönemdeki haberlerde öne çıkan temel hukuki tartışma şudur: Devletin onayladığı süreçlere güvenerek yatırım yapan kişiler, sonradan ortaya çıkan hatalardan sorumlu tutulabilir mi?</p><p>Bu noktada Danıştay içtihatları, idarenin takdir yetkisinin <strong>sınırsız olmadığını</strong> ve kararların somut delillere dayanması gerektiğini vurgulamaktadır.</p><h4>8. Sonuç ve Değerlendirme</h4><p>İstanbul'da gündeme gelen vatandaşlık iptali iddiaları, aslında Türk vatandaşlık hukukunun uzun süredir tartışılan bir alanına işaret etmektedir:</p><ul><li>Vatandaşlık kazanımı kadar <strong>korunması da hukuki güvenceye bağlıdır</strong></li><li>Özellikle yatırım yoluyla vatandaşlıkta <strong>ekspertiz ve idari süreçlerin doğruluğu kritik önemdedir</strong></li><li>İptal kararlarına karşı <strong>etkin yargı yolu</strong>, en önemli hak arama mekanizmasıdır</li></ul><p>Bu nedenle, vatandaşlık iptali riskiyle karşı karşıya kalan kişilerin <strong>uzman bir idare hukuku avukatından destek alması</strong> büyük önem taşımaktadır.</p>",

            sss: "S.S.S.",
            sss_baslik: "SIKÇA SORULAN SORULAR",
            sss_alt_baslik: "Merak Ettikleriniz",
            sss_aciklama: "Hukuki süreçler hakkında en çok sorulan soruların cevaplarını aşağıda bulabilirsiniz.",
            sss_cta_text: "Sorunuzun cevabını bulamadınız mı? Bize ulaşın!",
            sss_genel: "Genel Sorular",
            sss_bosanma: "Boşanma ve Aile Hukuku",
            sss_yabancilar: "Yabancılar Hukuku ve Vatandaşlık",
            sss_is_hukuku: "İş Hukuku",
            sss_kira: "Kira ve Gayrimenkul Hukuku",
            sss_miras: "Miras Hukuku",
            sss_trafik: "Trafik Kazaları ve Tazminat",
            sss_trafik_aciklama: "Türk Vatandaşları ve Yabancı Vatandaşlar Aynı Haklara Sahip Olup Trafik Kazalarında Aynı Usuller Geçerlidir",
            sss_soru_1: "Online danışmanlık hizmetinin kapsamı nedir?",
            sss_cevap_1: "Büromuz WhatsApp, telefon ve video konferans aracılığıyla online hukuki danışmanlık sunmaktadır. Özellikle yurt dışındaki müvekkillere bu yöntemle kesintisiz hizmet verilmektedir.",
            sss_soru_2: "Yabancı dilde hizmet sunuyor musunuz?",
            sss_cevap_2: "Bünyemizde Farsça ve İngilizce bilen avukatımız bulunmaktadır. İranlı ve Farsça konuşan müvekkillerimize ana dillerinde hukuki danışmanlık sağlanmaktadır.",
            sss_soru_3: "Avukat danışmanlık ücreti ne kadar?",
            sss_cevap_3: "Danışmanlık ücretleri davanın türüne ve karmaşıklığına göre değişiklik göstermektedir. Ücretlendirme konusunda şeffaf bir politika izlenmektedir. Detaylı bilgi için ilk görüşme öncesi büromuzla iletişime geçebilirsiniz.",
            sss_soru_4: "Boşanma davası ne kadar sürer?",
            sss_cevap_4: "Anlaşmalı davalar genellikle 1-3 ay içinde sonuçlanır. Çekişmeli davalar, davanın karmaşıklığı ve mahkemenin iş yüküne bağlı olarak 1-3 yıl sürebilir.",
            sss_soru_5: "Yabancı uyruklu birinin Türkiye'de boşanması için şartlar nelerdir?",
            sss_cevap_5: "Eşlerden birinin Türkiye'de yaşaması veya evliliğin Türkiye'de yapılmış olması yetki için yeterlidir. Başvuru esnasında pasaport, evlilik cüzdanı ve varsa apostilli belgelerin asılları gereklidir.",
            sss_soru_6: "Nafaka ve Velayet süreçleri nasıl işler?",
            sss_cevap_6: "Boşanma sürecinde çocukların üstün yararı gözetilerek velayet kararı verilir. Ayrıca eşin ve çocukların geçimi için mahkemece tedbir, yoksulluk veya iştirak nafakasına hükmedilebilir.",
            sss_soru_7: "Çalışma izni süreci nasıl işler?",
            sss_cevap_7: "Başvurular yurt içinden e-Devlet (Bakanlık) üzerinden, yurt dışından ise Türk konsoloslukları aracılığıyla yapılır. Sürecin tamamlanması genellikle 30-60 gün sürer.",
            sss_soru_8: "Yatırım yoluyla vatandaşlık için güncel alt limitler nelerdir?",
            sss_cevap_8: "En az 400.000 USD değerinde gayrimenkul alımı, 500.000 USD sabit sermaye yatırımı veya bankaya 500.000 USD yatırılması gerekmektedir. İşlemlerin sonuçlanması 6 ay - 1 yıl arası sürer.",
            sss_soru_9: "İkamet izni (Oturma İzni) başvurusu için ne gereklidir?",
            sss_cevap_9: "Kısa dönem, aile veya öğrenci ikamet izni gibi türlere göre değişmekle birlikte; geçerli sağlık sigortası, kalacak yer beyanı ve geçim imkanını kanıtlayan belgeler temel gerekliliklerdir.",
            sss_soru_10: "İşten çıkarılan bir işçi hangi haklara sahiptir?",
            sss_cevap_10: "En az 1 yıl çalışan işçi kıdem tazminatı almaya hak kazanır. Fesih şekline göre ihbar tazminatı, fazla mesai, yıllık izin ücreti ve kötüniyet tazminatı talep edilebilir.",
            sss_soru_11: "İş kazası sonrası maddi ve manevi tazminat davası nasıl açılır?",
            sss_cevap_11: "Kazanın ardından SGK tespiti ve kusur oranlarının belirlenmesiyle işverene karşı tazminat davası açılabilir.",
            sss_soru_12: "Kira artış oranları nasıl hesaplanır?",
            sss_cevap_12: "Konutlarda artış oranı, bir önceki yılın TÜFE oranını geçemez. Taraflar TÜFE'nin altında bir oran belirleyebilir ancak yasal sınırın üzerine çıkamazlar. Ticari kiralar bu kuraldan farklı değerlendirilir.",
            sss_soru_13: "Kira tahliye davası hangi durumlarda açılır?",
            sss_cevap_13: "Kira bedelinin ödenmemesi, ihtiyacın doğması, on yıllık uzama süresinin dolması veya tahliye taahhüdü gibi yasal gerekçelerle tahliye davası açılabilir.",
            sss_soru_14: "Tahliye taahhütnamesi nedir, geçerli midir?",
            sss_cevap_14: "Kiracının kiralananı belirli bir tarihte boşaltmayı yazılı olarak taahhüt etmesidir. Geçerli olması için kira sözleşmesinden sonraki bir tarihte imzalanmış olması gerekir.",
            sss_soru_15: "Miras davalarında zamanaşımı süreleri nelerdir?",
            sss_cevap_15: "Tenkis Davası: Öğrenme tarihinden itibaren 1 yıl, ölümden itibaren 10 yıldır. İstihkak Davası: İyi niyetli kişilere karşı 1 yıl, kötü niyetli kişilere karşı 20 yıldır.",
            sss_soru_16: "Mirasçılık Belgesi (Veraset İlamı) nereden alınır?",
            sss_cevap_16: "Mirasçı olduğunu kanıtlayan bu belge noterlerden veya Sulh Hukuk Mahkemelerinden talep edilebilir. Yabancılık unsuru içeren durumlarda mahkeme yolu izlenmelidir.",
            sss_soru_17: "Reddi miras (mirasın reddi) süresi ne kadardır?",
            sss_cevap_17: "Mirasçılar, ölüm tarihinden itibaren 3 ay içinde mahkemeye başvurarak mirası reddedebilirler.",
            sss_soru_18: "Trafik kazası sonrası hangi tazminatları talep edebilirim?",
            sss_cevap_18: "Kazada yaralanma varsa; tedavi giderleri, iş göremezlik tazminatı (geçici veya sürekli) ve manevi tazminat talep edilebilir. Ölümle sonuçlanan kazalarda; destekten yoksun kalma tazminatı, cenaze ve defin giderleri ile yakınların manevi tazminat hakları doğar.",
            sss_soru_19: "Değer kaybı tazminatı nedir, nasıl alınır?",
            sss_cevap_19: "Kazada kusursuz veya az kusurlu olan taraf, aracının kazadan dolayı piyasa değerinde oluşan düşüşü (değer kaybı) karşı tarafın trafik sigortasından (ZMSS) talep edebilir. Genellikle kazadan itibaren 2 yıl içinde başvuru yapılmalıdır.",
            sss_soru_20: "Trafik kazası tazminat davalarında zamanaşımı süresi ne kadardır?",
            sss_cevap_20: "Motorlu araç kazalarından doğan maddi ve manevi tazminat davalarında zamanaşımı, kaza tarihinden itibaren kural olarak 2 yıldır. Ancak kaza aynı zamanda bir suç teşkil ediyorsa (yaralamalı veya ölümlü kaza gibi), ceza zamanaşımı süreleri uygulanır ki bu süre 8 ila 15 yıla kadar çıkabilir.",
            sss_soru_21: "Kusur oranına nasıl itiraz edilir?",
            sss_cevap_21: "Kaza tespit tutanağındaki kusur oranlarına karşı, tutanağın tebliğinden itibaren yasal süreler içinde Sigorta Bilgi ve Gözetim Merkezi (SBM) üzerinden veya doğrudan Asliye Ticaret Mahkemelerinde dava açarak itiraz edilebilir.",
            sss_soru_22: "Sigorta şirketi tazminatı eksik öderse ne yapılmalı?",
            sss_cevap_22: "Sigorta şirketinin ödediği tutar gerçek zararı karşılamıyorsa, bakiye kalan kısım için Sigorta Tahkim Komisyonu'na başvurulabilir veya dava açılabilir.",
            sss_soru_23: "Alkollü araç kullanırken kaza yapılırsa sigorta ödeme yapar mı?",
            sss_cevap_23: "Sigorta şirketi zarar gören üçüncü kişilere ödeme yapar, ancak sürücü ağır kusurlu veya yasaklı düzeyde alkollü ise ödediği tutarı kendi sigortalısından (rücu yoluyla) geri talep eder.",
            sss_soru_24: "Maddi hasarlı kazalarda polis çağırmak şart mı?",
            sss_cevap_24: "Taraflar kaza yerinde anlaşabiliyorsa 'Maddi Hasarlı Trafik Kazası Tespit Tutanağı'nı kendileri doldurup imzalayabilirler. Ancak yaralanma, kamu malına zarar veya taraflardan birinin ehliyetinin olmaması gibi durumlarda mutlaka polis veya jandarma çağrılmalıdır.",
            sss_soru_25: "Vur-kaç kazalarında (faili meçhul) tazminat nasıl alınır?",
            sss_cevap_25: "Çarpan aracın tespit edilemediği veya sigortasının olmadığı durumlarda, bedensel zararlar (ölüm ve sakatlanma) için Güvence Hesabı'na başvuru yapılarak tazminat alınabilir.",
            blog_filtre_tumu: "Tümü",
            blog_filtre_yabancilar: "Yabancılar Hukuku",
            blog_filtre_is: "İş Hukuku",
            blog_filtre_kira: "Kira Hukuku",
            blog_filtre_miras: "Miras Hukuku",
            blog_filtre_tuketici: "Tüketici Hukuku",
            blog_filtre_bosanma: "Boşanma Hukuku",
            blog_filtre_saglik: "Sağlık Hukuku",
            blog_filtre_tazminat: "Tazminat Hukuku",
            blog_badge_yabancilar: "Yabancılar Hukuku",
            blog_badge_is: "İş Hukuku",
            blog_badge_kira: "Kira Hukuku",
            blog_badge_miras: "Miras Hukuku",
            blog_badge_tuketici: "Tüketici Hukuku",
            blog_badge_bosanma: "Boşanma Hukuku",
            blog_badge_saglik: "Sağlık Hukuku",
            blog_badge_tazminat: "Tazminat Hukuku",
            kvkk_text: "Bu web sitesi, deneyiminizi geliştirmek için çerezler kullanmaktadır. Siteyi kullanmaya devam ederek çerez politikamızı kabul etmiş olursunuz.",
            kvkk_kabul: "Kabul Et",
            blog_onceki: "Önceki Yazı",
            blog_sonraki: "Sonraki Yazı",
            blog_diger_yazilar: "Diğer Yazılar",
    ...
    $(document).ready(function () {
        ...
        function setLanguage(lang) {
            ...
            var heroWa = document.getElementById('heroWhatsapp');
            if (lang === 'fa') {
                switchToPersian();
                document.getElementById('navbar').classList.add('rtl');
                whatsappButton.href = "https://wa.me/905424056094?text=%D8%B3%D9%84%D8%A7%D9%85%D8%8C%20%D8%A7%D8%B2%20%D8%B7%D8%B1%DB%8C%D9%82%20%D9%88%D8%A8%20%D8%B3%D8%A7%DB%8C%D8%AA%20%D8%B4%D9%85%D8%A7%20%D8%AA%D9%85%D8%A7%D8%B3%20%D9%85%DB%8C%20%DA%AF%DB%8C%D8%B1%D9%85.%20%D9%85%DB%8C%20%D8%AE%D9%88%D8%A7%D9%87%D9%85%20%D9%85%D8%B4%D8%A7%D9%88%D8%B1%D9%87%20%D8%AD%D9%82%D9%88%D9%82%DB%8C%20%D8%AF%D8%B1%DB%8C%D8%A7%D9%81%D8%AA%20%DA%A9%D9%86%D9%85.";
                if (heroWa) heroWa.href = "https://wa.me/905424056094?text=%D8%B3%D9%84%D8%A7%D9%85%D8%8C%20%D8%A7%D8%B2%20%D8%B7%D8%B1%DB%8C%D9%82%20%D9%88%D8%A8%20%D8%B3%D8%A7%DB%8C%D8%AA%20%D8%B4%D9%85%D8%A7%20%D8%AA%D9%85%D8%A7%D8%B3%20%D9%85%DB%8C%20%DA%AF%DB%8C%D8%B1%D9%85.%20%D9%85%DB%8C%20%D8%AE%D9%88%D8%A7%D9%87%D9%85%20%D9%85%D8%B4%D8%A7%D9%88%D8%B1%D9%87%20%D8%AD%D9%82%D9%88%D9%82%DB%8C%20%D8%AF%D8%B1%DB%8C%D8%A7%D9%81%D8%AA%20%DA%A9%D9%86%D9%85.";
            } else {
                switchToTurkish();
                document.getElementById('navbar').classList.remove('rtl');
                whatsappButton.href = "https://wa.me/905543039854?text=Merhaba%2C%20web%20sitenizden%20ula%C5%9F%C4%B1yorum.%20Hukuki%20dan%C4%B1%C5%9Fmanl%C4%B1k%20almak%20istiyorum.";
                if (heroWa) heroWa.href = "https://wa.me/905543039854?text=Merhaba%2C%20web%20sitenizden%20ula%C5%9F%C4%B1yorum.%20Hukuki%20dan%C4%B1%C5%9Fmanl%C4%B1k%20almak%20istiyorum.";
            }
        }
